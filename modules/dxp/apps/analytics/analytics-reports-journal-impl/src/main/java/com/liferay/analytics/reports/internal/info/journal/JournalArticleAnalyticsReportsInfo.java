...
package com.liferay.analytics.reports.internal.info.journal;
 ...
 * @author David Arques
 */
@Component(service = AnalyticsReportsInfo.class)
public class JournalArticleAnalyticsReportsInfo
	implements AnalyticsReportsInfo<JournalArticle> {
