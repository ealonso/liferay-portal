...
public static class AlloyControllerImpl extends PatcherAlloyControllerImpl {
	...
	public void index() throws Exception {
		...
		List<PatcherProductVersion> patcherProductVersions = PatcherProductVersionLocalServiceUtil.getPatcherProductVersions(QueryUtil.ALL_POS, QueryUtil.ALL_POS);

		renderRequest.setAttribute("patcherProductVersions", patcherProductVersions);
