...
<aui:field-wrapper name="modifiedDate">
	<fmt:formatDate type="both" value="${patcherFix.modifiedDate}" />
</aui:field-wrapper>

<aui:field-wrapper name="statusDate">
	<fmt:formatDate type="both" value="${patcherFix.statusDate}" />
</aui:field-wrapper>
	...
	<liferay-ui:search-container>
		...
		>
			...
			<liferay-ui:search-container-column-text
				name="modified-date"
			>
				<fmt:formatDate type="both" value="${patcherFixKeyVersion.modifiedDate}" />
			</liferay-ui:search-container-column-text>
