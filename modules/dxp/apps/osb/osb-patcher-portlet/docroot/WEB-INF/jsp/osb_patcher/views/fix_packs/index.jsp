...
<liferay-ui:search-container emptyResultsMessage="there-are-no-fix-packs" iteratorURL="${alloySearchResult.portletURL}">
	...
	>
		...
		<liferay-ui:search-container-column-text
			name="released-date"
		>
			<fmt:formatDate value="${patcherFixPack.releasedDate}" />
		</liferay-ui:search-container-column-text>
