...
<aui:button-row>
	...
	<aui:button disabled='${!PatcherPermission.contains(themeDisplay, "builds", "create")}' href="${createPatcherBuildURL}" value="create-build" />
</aui:button-row>
...
<liferay-ui:search-container emptyResultsMessage="there-are-no-builds" iteratorURL="${alloySearchResult.portletURL}">
	...
	>
		<liferay-ui:search-container-row-parameter name="className" value="patcher-build-type-${PatcherBuildConstantsMethods.getTypeLabel(patcherBuild.type)}" />
