...
<aui:script>
	...
	function _getUseExistingHotfixValue() {
		Liferay.Service(
			'/osb-patcher-portlet.builds/hotfixExists',
			{
	...
	AUI().ready(function () {
		...
		var projectVersionId =
			${not empty patcherProjectVersionId ? patcherProjectVersionId : 0};
	...
	YUI().ready('aui-popover', function (Y) {
		...
		var tickets = document.getElementById(
			'_1_WAR_osbpatcherportlet_troubleshootingTicketList'
		);
