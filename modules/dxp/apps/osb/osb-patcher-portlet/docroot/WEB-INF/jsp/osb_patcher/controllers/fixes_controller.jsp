...
public static class AlloyControllerImpl extends PatcherAlloyControllerImpl {
	...
	public void setFixPackFields() throws Exception {
		...
		int fixPackStatus = ParamUtil.getInteger(request, "fixPackStatus");

		patcherFix.setFixPackStatus(fixPackStatus);

		String requirements = ParamUtil.getString(request, "requirements");
	...
	private void _validateSiblingProjectVersionFixes() throws Exception {
		...
		for (PatcherFix siblingPatcherProjectVersionFix : siblingPatcherProjectVersionFixes) {
			...
			List<String> tickets = PatcherUtil.getTickets(siblingPatcherProjectVersionFix.getName());

			siblingPatcherProjectVersionFixTickets.addAll(tickets);
		}
