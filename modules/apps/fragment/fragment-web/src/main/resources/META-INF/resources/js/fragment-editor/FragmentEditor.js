                        ...
                        <div className="btn-group btn-group-nowrap float-right mt-1">
                            {readOnly ? (
                                <span className="pr-3 pt-1 text-info">
                                    ...
                                    <span>{Liferay.Language.get('read-only-view')}</span>
                                </span>
                            ) : (
                                <>
                                    {propagationEnabled && (
                                        <span
                                            ...
                                            data-title={Liferay.Language.get('automatic-propagation-enabled-help')}
                                        >
                                            <ClayIcon symbol="exclamation-circle" />

                                            <span>{Liferay.Language.get('automatic-propagation-enabled')}</span>
                                        </span>
                                    )}

                                    <div className="btn-group-item custom-control custom-checkbox ml-2 mr-4 mt-1">
                                        <label
                                            className="lfr-portal-tooltip"
                                            data-title={Liferay.Language.get('cacheable-fragment-help')}
                                        >
                                            <input
                                                checked={cacheable}
                                            ...
                                            <span className="custom-control-label">
                                                <span className="custom-control-label-text">
                                                    {Liferay.Language.get('cacheable')}
                                                </span>
                                            </span>
                                        </label>
                                    </div>
