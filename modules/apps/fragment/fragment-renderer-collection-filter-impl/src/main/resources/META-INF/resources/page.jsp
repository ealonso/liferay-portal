...
String targetCollections = (String)request.getAttribute("targetCollections");
...
<liferay-frontend:component
	context='<%=
		HashMapBuilder.<String, Object>put(
			"fragmentEntryLinkId", String.valueOf(fragmentEntryLink.getFragmentEntryLinkId())
		).put(
			"targetCollections", targetCollections
		).build()
	%>'
	module="js/FragmentEntryLinkTargetCollectionsRegister"
/>