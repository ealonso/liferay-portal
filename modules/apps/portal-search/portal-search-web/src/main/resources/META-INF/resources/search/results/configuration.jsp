	...
	<liferay-frontend:edit-form-body>
		<liferay-frontend:fieldset-group>
			...
			>
				...
				<aui:input label="display-layout-warning-in-staging" name="<%= PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_KEY_DISPLAY_LAYOUT_WARNING_IN_STAGING) %>" type="checkbox" value="<%= searchResultsPortletPreferences.isDisplayLayoutWarningInStaging() %>" />
