...
page import="com.liferay.users.admin.web.internal.servlet.taglib.clay.OrganizationVerticalCard" %><%@
page import="com.liferay.users.admin.web.internal.servlet.taglib.clay.UserVerticalCard" %><%@
