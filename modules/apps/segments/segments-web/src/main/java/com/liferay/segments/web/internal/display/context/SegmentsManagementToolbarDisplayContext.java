...
public class SegmentsManagementToolbarDisplayContext
	...
	public int getTotalItems() throws PortalException {
		SearchContainer<?> searchContainer =
			_segmentsDisplayContext.getSearchContainer();
	...
	public boolean isAsahEnabled(long companyId) throws Exception {
		AnalyticsSettingsManager analyticsSettingsManager =
			_segmentsDisplayContext.getAnalyticsSettingsManager();
	...
	private boolean _isSearch() {
		if (Validator.isNotNull(_segmentsDisplayContext.getKeywords())) {
			return true;
		}
