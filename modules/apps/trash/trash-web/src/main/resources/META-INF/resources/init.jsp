...
page import="com.liferay.trash.handler.TrashHandler" %><%@
page import="com.liferay.trash.model.TrashEntry" %><%@
page import="com.liferay.trash.renderer.TrashRenderer" %><%@
page import="com.liferay.trash.service.TrashEntryLocalServiceUtil" %><%@
page import="com.liferay.trash.util.TrashHandlerRegistryUtil" %><%@
