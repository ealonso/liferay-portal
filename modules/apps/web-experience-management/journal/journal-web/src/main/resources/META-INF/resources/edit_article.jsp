...
if (ddmStructureId > 0) {
	...
	ddmStructure = DDMStructureLocalServiceUtil.fetchStructure(article.getGroupId(), PortalUtil.getClassNameId(JournalArticle.class), ddmStructureKey, true);
}
...
if (ddmTemplateId > 0) {
	...
	ddmTemplate = DDMTemplateLocalServiceUtil.fetchTemplate(article.getGroupId(), PortalUtil.getClassNameId(DDMStructure.class), ddmTemplateKey, true);
}
