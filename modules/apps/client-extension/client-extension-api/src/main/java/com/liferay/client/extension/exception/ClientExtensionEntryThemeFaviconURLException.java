 ...
 */
public class ClientExtensionEntryThemeFaviconURLException extends PortalException {
	...
	public ClientExtensionEntryThemeFaviconURLException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
