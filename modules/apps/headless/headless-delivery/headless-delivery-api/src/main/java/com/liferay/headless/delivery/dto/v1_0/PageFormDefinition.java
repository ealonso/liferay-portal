...
public class PageFormDefinition implements Serializable {
	...
	@Schema(description = "The form subtype.")
	@Valid
	public FormSubtype getFormSubtype() {
		return formSubtype;
	}

	public void setFormSubtype(FormSubtype formSubtype) {
		this.formSubtype = formSubtype;
	}

	@JsonIgnore
	public void setFormSubtype(
		UnsafeSupplier<FormSubtype, Exception> formSubtypeUnsafeSupplier) {

		try {
			formSubtype = formSubtypeUnsafeSupplier.get();
		}
	...
	@GraphQLField(description = "The form subtype.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected FormSubtype formSubtype;

	@Schema(description = "The type of form.")
	@Valid
	...
	@GraphQLField(description = "The type of form.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public String toString() {
		...
		if (formSubtype != null) {
			...
			sb.append(String.valueOf(formSubtype));
		}
		...
		if (formType != null) {
			...
			sb.append(String.valueOf(formType));
		}
