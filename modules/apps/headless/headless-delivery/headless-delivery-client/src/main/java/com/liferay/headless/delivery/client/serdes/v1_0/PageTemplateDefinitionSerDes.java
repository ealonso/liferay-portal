...
public class PageTemplateDefinitionSerDes {
	...
	public static String toJSON(PageTemplateDefinition pageTemplateDefinition) {
		...
		if (pageTemplateDefinition.getPageElements() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < pageTemplateDefinition.getPageElements().length;
				 i++) {

				sb.append(
					String.valueOf(
						pageTemplateDefinition.getPageElements()[i]));

				if ((i + 1) < pageTemplateDefinition.getPageElements().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(
		...
		if (pageTemplateDefinition.getPageElements() == null) {
			...
			map.put(
				"pageElements",
				String.valueOf(pageTemplateDefinition.getPageElements()));
		}
	...
	public static class PageTemplateDefinitionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "collectionName")) {
				...
				if (jsonParserFieldValue != null) {
					pageTemplateDefinition.setPageElements(
						Stream.of(
