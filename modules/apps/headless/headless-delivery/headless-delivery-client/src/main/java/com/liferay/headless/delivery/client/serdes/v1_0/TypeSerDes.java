...
import com.liferay.headless.delivery.client.dto.v1_0.Type;
...
public class TypeSerDes {
	...
	public static String toJSON(Type type) {
		...
		if (type.getClassName() != null) {
			...
			sb.append(_escape(type.getClassName()));
	...
	public static Map<String, String> toMap(Type type) {
		...
		if (type.getClassName() == null) {
			...
			map.put("className", String.valueOf(type.getClassName()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "className")) {
				if (jsonParserFieldValue != null) {
					type.setClassName((String)jsonParserFieldValue);
				}
			}
		}
