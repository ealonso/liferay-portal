...
public class PageFormDefinitionSerDes {
	...
	public static String toJSON(PageFormDefinition pageFormDefinition) {
		...
		if (pageFormDefinition.getFormSubtype() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"formSubtype\": ");

			sb.append(String.valueOf(pageFormDefinition.getFormSubtype()));
		}

		if (pageFormDefinition.getFormType() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(pageFormDefinition.getFormType()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (pageFormDefinition.getFormSubtype() == null) {
			map.put("formSubtype", null);
		}
		else {
			map.put(
				"formSubtype",
				String.valueOf(pageFormDefinition.getFormSubtype()));
		}
		...
		if (pageFormDefinition.getFormType() == null) {
			...
			map.put(
				"formType", String.valueOf(pageFormDefinition.getFormType()));
		}
	...
	public static class PageFormDefinitionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "formSubtype")) {
				if (jsonParserFieldValue != null) {
					pageFormDefinition.setFormSubtype(
						FormSubtypeSerDes.toDTO((String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "formType")) {
				if (jsonParserFieldValue != null) {
					pageFormDefinition.setFormType(
						FormTypeSerDes.toDTO((String)jsonParserFieldValue));
				}
			}
		}
