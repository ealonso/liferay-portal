...
/**
 * Provides the local service interface for FragmentLayoutTemplateLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FragmentLayoutTemplateLinkLocalServiceUtil
...
public interface FragmentLayoutTemplateLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FragmentLayoutTemplateLinkLocalServiceUtil} to access the fragment layout template link local service. Add custom service methods to {@link com.liferay.fragment.service.impl.FragmentLayoutTemplateLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
