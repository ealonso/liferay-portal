...
/**
 * Provides the local service interface for FragmentEntryLayoutTemplateLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FragmentEntryLayoutTemplateLinkLocalServiceUtil
...
public interface FragmentEntryLayoutTemplateLinkLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FragmentEntryLayoutTemplateLinkLocalServiceUtil} to access the fragment entry layout template link local service. Add custom service methods to {@link com.liferay.fragment.service.impl.FragmentEntryLayoutTemplateLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public FragmentEntryLayoutTemplateLink createFragmentEntryLayoutTemplateLink(
	...
	*/
	...
	public FragmentEntryLayoutTemplateLink fetchFragmentEntryLayoutTemplateLink(
		long fragmentEntryLayoutTemplateLinkId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FragmentEntryLayoutTemplateLink getFragmentEntryLayoutTemplateLink(
		long fragmentEntryLayoutTemplateLinkId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FragmentEntryLayoutTemplateLink> getFragmentEntryLayoutTemplateLinks(
		int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public FragmentEntryLayoutTemplateLink updateFragmentEntryLayoutTemplateLink(
		FragmentEntryLayoutTemplateLink fragmentEntryLayoutTemplateLink);
}