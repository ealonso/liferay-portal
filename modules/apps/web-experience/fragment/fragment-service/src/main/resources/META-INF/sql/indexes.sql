...
create index IX_6DB59386 on FragmentEntryLink (groupId, fragmentEntryId, classNameId, position);
create index IX_16DF5022 on FragmentEntryLink (groupId, fragmentEntryId, position);
