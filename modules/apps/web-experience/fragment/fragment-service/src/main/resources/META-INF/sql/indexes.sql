...
create index IX_4DB834F7 on FragmentLayoutTemplateLink (groupId, fragmentEntryId);
create index IX_C03F2034 on FragmentLayoutTemplateLink (groupId, layoutPageTemplateEntryId);