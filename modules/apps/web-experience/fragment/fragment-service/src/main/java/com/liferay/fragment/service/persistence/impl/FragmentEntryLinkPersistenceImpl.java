...
public class FragmentEntryLinkPersistenceImpl extends BasePersistenceImpl<FragmentEntryLink>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_P = new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryLinkImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_P = new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryLinkImpl.class,
			...
			FragmentEntryLinkModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			FragmentEntryLinkModelImpl.CLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_F_P = new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 ...
	 */
	@Override
	public List<FragmentEntryLink> findByG_F_P(long groupId,
		long fragmentEntryId, int position) {
		return findByG_F_P(groupId, fragmentEntryId, position,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryLinkModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<FragmentEntryLink> findByG_F_P(long groupId,
		long fragmentEntryId, int position, int start, int end) {
		return findByG_F_P(groupId, fragmentEntryId, position, start, end, null);
	}

	/**
	 * Returns an ordered range of all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryLinkModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<FragmentEntryLink> findByG_F_P(long groupId,
		long fragmentEntryId, int position, int start, int end,
		OrderByComparator<FragmentEntryLink> orderByComparator) {
		return findByG_F_P(groupId, fragmentEntryId, position, start, end,
			orderByComparator, true);
	}
	...
	public List<FragmentEntryLink> findByG_F_P(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_P;
			finderArgs = new Object[] { groupId, fragmentEntryId, position };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_P;
			finderArgs = new Object[] {
					groupId, fragmentEntryId, position,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_F_P_GROUPID_2);

			query.append(_FINDER_COLUMN_G_F_P_FRAGMENTENTRYID_2);

			query.append(_FINDER_COLUMN_G_F_P_POSITION_2);
	...
	/**
	 * Returns the first fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param position the position
	 ...
	 */
	@Override
	public FragmentEntryLink findByG_F_P_First(long groupId,
		long fragmentEntryId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = fetchByG_F_P_First(groupId,
				fragmentEntryId, position, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntryLink fetchByG_F_P_First(long groupId,
		long fragmentEntryId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator) {
		List<FragmentEntryLink> list = findByG_F_P(groupId, fragmentEntryId,
	...
	/**
	 * Returns the last fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param position the position
	 ...
	 */
	@Override
	public FragmentEntryLink findByG_F_P_Last(long groupId,
		long fragmentEntryId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = fetchByG_F_P_Last(groupId,
				fragmentEntryId, position, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntryLink fetchByG_F_P_Last(long groupId,
		long fragmentEntryId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator) {
		int count = countByG_F_P(groupId, fragmentEntryId, position);
	...
	/**
	 * Returns the fragment entry links before and after the current fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * @param fragmentEntryLinkId the primary key of the current fragment entry link
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	...
	public FragmentEntryLink[] findByG_F_P_PrevAndNext(
		...
		int position, OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = findByPrimaryKey(fragmentEntryLinkId);
		...
		try {
			...
			array[0] = getByG_F_P_PrevAndNext(session, fragmentEntryLink,
					groupId, fragmentEntryId, position, orderByComparator, true);

			array[1] = fragmentEntryLink;

			array[2] = getByG_F_P_PrevAndNext(session, fragmentEntryLink,
					groupId, fragmentEntryId, position, orderByComparator, false);
	...
	protected FragmentEntryLink getByG_F_P_PrevAndNext(Session session,
		FragmentEntryLink fragmentEntryLink, long groupId,
		long fragmentEntryId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and position = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param position the position
	 */
	@Override
	public void removeByG_F_P(long groupId, long fragmentEntryId, int position) {
		for (FragmentEntryLink fragmentEntryLink : findByG_F_P(groupId,
				fragmentEntryId, position, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(fragmentEntryLink);
		}
	}
	...
	/**
	 * Returns the number of fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param position the position
	 ...
	 */
	@Override
	public int countByG_F_P(long groupId, long fragmentEntryId, int position) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_F_P;

		Object[] finderArgs = new Object[] { groupId, fragmentEntryId, position };
	...
	private static final String _FINDER_COLUMN_G_F_P_GROUPID_2 = "fragmentEntryLink.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_P_FRAGMENTENTRYID_2 = "fragmentEntryLink.fragmentEntryId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_P_POSITION_2 = "fragmentEntryLink.position = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_C_P = new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryLinkImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_F_C_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_C_P =
		new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryLinkImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_F_C_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
			...
			FragmentEntryLinkModelImpl.POSITION_COLUMN_BITMASK |
			FragmentEntryLinkModelImpl.CLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_F_C_P = new FinderPath(FragmentEntryLinkModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryLinkModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_F_C_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	/**
	 * Returns all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public List<FragmentEntryLink> findByG_F_C_P(long groupId,
		long fragmentEntryId, long classNameId, int position) {
		return findByG_F_C_P(groupId, fragmentEntryId, classNameId, position,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryLinkModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<FragmentEntryLink> findByG_F_C_P(long groupId,
		long fragmentEntryId, long classNameId, int position, int start, int end) {
		return findByG_F_C_P(groupId, fragmentEntryId, classNameId, position,
			start, end, null);
	}

	/**
	 * Returns an ordered range of all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryLinkModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<FragmentEntryLink> findByG_F_C_P(long groupId,
		long fragmentEntryId, long classNameId, int position, int start,
		int end, OrderByComparator<FragmentEntryLink> orderByComparator) {
		return findByG_F_C_P(groupId, fragmentEntryId, classNameId, position,
	...
	public List<FragmentEntryLink> findByG_F_C_P(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_C_P;
			finderArgs = new Object[] {
					groupId, fragmentEntryId, classNameId, position
				};
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_F_C_P;
			finderArgs = new Object[] {
					groupId, fragmentEntryId, classNameId, position,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_F_C_P_GROUPID_2);

			query.append(_FINDER_COLUMN_G_F_C_P_FRAGMENTENTRYID_2);

			query.append(_FINDER_COLUMN_G_F_C_P_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_G_F_C_P_POSITION_2);
	...
	/**
	 * Returns the first fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public FragmentEntryLink findByG_F_C_P_First(long groupId,
		long fragmentEntryId, long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = fetchByG_F_C_P_First(groupId,
				fragmentEntryId, classNameId, position, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntryLink fetchByG_F_C_P_First(long groupId,
		long fragmentEntryId, long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator) {
		List<FragmentEntryLink> list = findByG_F_C_P(groupId, fragmentEntryId,
				classNameId, position, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public FragmentEntryLink findByG_F_C_P_Last(long groupId,
		long fragmentEntryId, long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = fetchByG_F_C_P_Last(groupId,
				fragmentEntryId, classNameId, position, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntryLink fetchByG_F_C_P_Last(long groupId,
		long fragmentEntryId, long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator) {
		int count = countByG_F_C_P(groupId, fragmentEntryId, classNameId,
				position);
		...
		List<FragmentEntryLink> list = findByG_F_C_P(groupId, fragmentEntryId,
				classNameId, position, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the fragment entry links before and after the current fragment entry link in the ordered set where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * @param fragmentEntryLinkId the primary key of the current fragment entry link
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 ...
	 */
	@Override
	public FragmentEntryLink[] findByG_F_C_P_PrevAndNext(
		long fragmentEntryLinkId, long groupId, long fragmentEntryId,
		long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator)
		throws NoSuchEntryLinkException {
		FragmentEntryLink fragmentEntryLink = findByPrimaryKey(fragmentEntryLinkId);
		...
		try {
			...
			array[0] = getByG_F_C_P_PrevAndNext(session, fragmentEntryLink,
					groupId, fragmentEntryId, classNameId, position,
					orderByComparator, true);

			array[1] = fragmentEntryLink;

			array[2] = getByG_F_C_P_PrevAndNext(session, fragmentEntryLink,
					groupId, fragmentEntryId, classNameId, position,
					orderByComparator, false);
	...
	protected FragmentEntryLink getByG_F_C_P_PrevAndNext(Session session,
		FragmentEntryLink fragmentEntryLink, long groupId,
		long fragmentEntryId, long classNameId, int position,
		OrderByComparator<FragmentEntryLink> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public void removeByG_F_C_P(long groupId, long fragmentEntryId,
		long classNameId, int position) {
		for (FragmentEntryLink fragmentEntryLink : findByG_F_C_P(groupId,
				fragmentEntryId, classNameId, position, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(fragmentEntryLink);
		}
	}
	...
	/**
	 * Returns the number of fragment entry links where groupId = &#63; and fragmentEntryId = &#63; and classNameId = &#63; and position = &#63;.
	 *
	 * @param groupId the group ID
	 * @param fragmentEntryId the fragment entry ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public int countByG_F_C_P(long groupId, long fragmentEntryId,
		long classNameId, int position) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_F_C_P;
	...
	private static final String _FINDER_COLUMN_G_F_C_P_GROUPID_2 = "fragmentEntryLink.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_C_P_FRAGMENTENTRYID_2 = "fragmentEntryLink.fragmentEntryId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_C_P_CLASSNAMEID_2 = "fragmentEntryLink.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_C_P_POSITION_2 = "fragmentEntryLink.position = ?";
		...
		if (!FragmentEntryLinkModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					fragmentEntryLinkModelImpl.getGroupId(),
					fragmentEntryLinkModelImpl.getFragmentEntryId(),
					fragmentEntryLinkModelImpl.getPosition()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_G_F_P, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_P,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_G_F_C_P, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_C_P,
				args);
			...
			if ((fragmentEntryLinkModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						fragmentEntryLinkModelImpl.getOriginalGroupId(),
						fragmentEntryLinkModelImpl.getOriginalFragmentEntryId(),
						fragmentEntryLinkModelImpl.getOriginalPosition()
					};
			...
			if ((fragmentEntryLinkModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_F_C_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						fragmentEntryLinkModelImpl.getOriginalGroupId(),
						fragmentEntryLinkModelImpl.getOriginalFragmentEntryId(),
						fragmentEntryLinkModelImpl.getOriginalClassNameId(),
