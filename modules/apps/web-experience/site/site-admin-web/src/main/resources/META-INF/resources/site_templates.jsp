		...
		<div class="row site-type-container">
			...
			>
				...
				>
					...
					<div class="col-md-3 entry-card lfr-asset-item site-template-card">
				...
				<div class="col-md-12">
					<liferay-ui:search-iterator markupView="lexicon" searchContainer="<%= layoutSetPrototypeSearchContainer %>" />
				</div>
			</liferay-ui:search-container>
		</div>
	</div>
