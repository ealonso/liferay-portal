...
public class GroupCreationStepServiceWrapperOrderComparator
	...
	@Override
	public int compare(
		ServiceWrapper<GroupCreationStep> serviceWrapper1,
		ServiceWrapper<GroupCreationStep> serviceWrapper2) {

		int displayOrder1 = MapUtil.getInteger(
			serviceWrapper1.getProperties(), "group.creation.step.order",
			Integer.MAX_VALUE);
		int displayOrder2 = MapUtil.getInteger(
			serviceWrapper2.getProperties(), "group.creation.step.order",
			Integer.MAX_VALUE);
