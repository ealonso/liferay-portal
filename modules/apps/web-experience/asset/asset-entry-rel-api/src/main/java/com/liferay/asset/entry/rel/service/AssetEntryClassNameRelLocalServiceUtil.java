...
/**
 * Provides the local service utility for AssetEntryClassNameRel. This utility wraps
 * {@link com.liferay.asset.entry.rel.service.impl.AssetEntryClassNameRelLocalServiceImpl} and is the
 ...
 * @see com.liferay.asset.entry.rel.service.base.AssetEntryClassNameRelLocalServiceBaseImpl
 * @see com.liferay.asset.entry.rel.service.impl.AssetEntryClassNameRelLocalServiceImpl
 * @generated
 */
@ProviderType
public class AssetEntryClassNameRelLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.asset.entry.rel.service.impl.AssetEntryClassNameRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.asset.entry.rel.model.AssetEntryClassNameRel createAssetEntryClassNameRel(
		long assetEntryClassNameRelId) {
		return getService()
				   .createAssetEntryClassNameRel(assetEntryClassNameRelId);
	}
	...
	*/
	public static com.liferay.asset.entry.rel.model.AssetEntryClassNameRel deleteAssetEntryClassNameRel(
		com.liferay.asset.entry.rel.model.AssetEntryClassNameRel assetEntryClassNameRel) {
		return getService().deleteAssetEntryClassNameRel(assetEntryClassNameRel);
	}
	...
	* @throws PortalException if a asset entry class name rel with the primary key could not be found
	*/
	public static com.liferay.asset.entry.rel.model.AssetEntryClassNameRel getAssetEntryClassNameRel(
		long assetEntryClassNameRelId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getAssetEntryClassNameRel(assetEntryClassNameRelId);
	}
	...
	*/
	public static java.util.List<com.liferay.asset.entry.rel.model.AssetEntryClassNameRel> getAssetEntryClassNameRels(
		int start, int end) {
		return getService().getAssetEntryClassNameRels(start, end);
	}
	...
	*/
	public static int getAssetEntryClassNameRelsCount() {
		return getService().getAssetEntryClassNameRelsCount();
	}
	...
	*/
	public static com.liferay.asset.entry.rel.model.AssetEntryClassNameRel updateAssetEntryClassNameRel(
		com.liferay.asset.entry.rel.model.AssetEntryClassNameRel assetEntryClassNameRel) {
		return getService().updateAssetEntryClassNameRel(assetEntryClassNameRel);
	}

	public static AssetEntryClassNameRelLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<AssetEntryClassNameRelLocalService, AssetEntryClassNameRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AssetEntryClassNameRelLocalService.class);

		ServiceTracker<AssetEntryClassNameRelLocalService, AssetEntryClassNameRelLocalService> serviceTracker =
			new ServiceTracker<AssetEntryClassNameRelLocalService, AssetEntryClassNameRelLocalService>(bundle.getBundleContext(),
				AssetEntryClassNameRelLocalService.class, null);
