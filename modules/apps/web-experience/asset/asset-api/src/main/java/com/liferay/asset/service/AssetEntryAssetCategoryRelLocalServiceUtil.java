 ...
 * {@link com.liferay.asset.service.impl.AssetEntryAssetCategoryRelLocalServiceImpl} and is the
 ...
 * @see com.liferay.asset.service.base.AssetEntryAssetCategoryRelLocalServiceBaseImpl
 * @see com.liferay.asset.service.impl.AssetEntryAssetCategoryRelLocalServiceImpl
 * @generated
 */
@ProviderType
public class AssetEntryAssetCategoryRelLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.asset.service.impl.AssetEntryAssetCategoryRelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel addAssetEntryAssetCategoryRel(
		com.liferay.asset.model.AssetEntryAssetCategoryRel assetEntryAssetCategoryRel) {
		return getService()
	...
	*
	* @param entryId the primary key for the new asset entry asset category rel
	* @return the new asset entry asset category rel
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel createAssetEntryAssetCategoryRel(
		long entryId) {
		return getService().createAssetEntryAssetCategoryRel(entryId);
	}
	...
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel deleteAssetEntryAssetCategoryRel(
		com.liferay.asset.model.AssetEntryAssetCategoryRel assetEntryAssetCategoryRel) {
		return getService()
	...
	*
	* @param entryId the primary key of the asset entry asset category rel
	* @return the asset entry asset category rel that was removed
	...
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel deleteAssetEntryAssetCategoryRel(
		...
		return getService().deleteAssetEntryAssetCategoryRel(entryId);
	}

	public static com.liferay.asset.model.AssetEntryAssetCategoryRel fetchAssetEntryAssetCategoryRel(
		long entryId) {
		return getService().fetchAssetEntryAssetCategoryRel(entryId);
	}
	...
	* @throws PortalException if a asset entry asset category rel with the primary key could not be found
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel getAssetEntryAssetCategoryRel(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getAssetEntryAssetCategoryRel(entryId);
	}
	...
	*/
	public static com.liferay.asset.model.AssetEntryAssetCategoryRel updateAssetEntryAssetCategoryRel(
		com.liferay.asset.model.AssetEntryAssetCategoryRel assetEntryAssetCategoryRel) {
		return getService()
	...
	*/
	public static java.util.List<com.liferay.asset.model.AssetEntryAssetCategoryRel> getAssetEntryAssetCategoryRels(
		int start, int end) {
