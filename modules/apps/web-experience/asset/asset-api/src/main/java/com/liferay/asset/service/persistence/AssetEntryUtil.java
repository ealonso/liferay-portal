 ...
 * @see com.liferay.asset.service.persistence.impl.AssetEntryPersistenceImpl
 * @generated
 */
@ProviderType
public class AssetEntryUtil {
	...
	*/
	public static AssetEntry findByGroupId_First(long groupId,
		OrderByComparator<AssetEntry> orderByComparator)
		throws com.liferay.asset.exception.NoSuchEntryException {
	...
	*/
	public static List<com.liferay.asset.model.AssetCategory> getAssetCategories(
		long pk) {
	...
	*/
	public static List<com.liferay.asset.model.AssetTag> getAssetTags(long pk) {
	...
	*/
	...
	private static ServiceTracker<AssetEntryPersistence, AssetEntryPersistence> _serviceTracker =
		ServiceTrackerFactory.open(AssetEntryPersistence.class);
}