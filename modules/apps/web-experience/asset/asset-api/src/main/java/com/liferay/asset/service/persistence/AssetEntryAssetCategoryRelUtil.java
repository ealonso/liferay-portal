 ...
 * @see com.liferay.asset.service.persistence.impl.AssetEntryAssetCategoryRelPersistenceImpl
 * @generated
 */
@ProviderType
public class AssetEntryAssetCategoryRelUtil {
	...
	*/
	public static AssetEntryAssetCategoryRel findByAssetEntryId_First(
		long assetEntryId,
		OrderByComparator<AssetEntryAssetCategoryRel> orderByComparator)
		throws com.liferay.asset.exception.NoSuchEntryAssetCategoryRelException {
		return getPersistence()
	...
	*/
	public static AssetEntryAssetCategoryRel[] findByAssetCategoryId_PrevAndNext(
		...
		throws com.liferay.asset.exception.NoSuchEntryAssetCategoryRelException {
		return getPersistence()
				   .findByAssetCategoryId_PrevAndNext(entryId, assetCategoryId,
			orderByComparator);
	}
	...
	*/
	public static AssetEntryAssetCategoryRel create(long entryId) {
	...
	* @throws NoSuchEntryAssetCategoryRelException if a asset entry asset category rel with the primary key could not be found
	*/
	public static AssetEntryAssetCategoryRel remove(long entryId)
		throws com.liferay.asset.exception.NoSuchEntryAssetCategoryRelException {
	...
	* @throws NoSuchEntryAssetCategoryRelException if a asset entry asset category rel with the primary key could not be found
	*/
	public static AssetEntryAssetCategoryRel findByPrimaryKey(long entryId)
		throws com.liferay.asset.exception.NoSuchEntryAssetCategoryRelException {
	...
	*/
	public static AssetEntryAssetCategoryRel fetchByPrimaryKey(long entryId) {
