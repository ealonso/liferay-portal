 ...
 * @see com.liferay.asset.service.persistence.impl.AssetLinkPersistenceImpl
 * @generated
 */
@ProviderType
public class AssetLinkUtil {
	...
	*/
	public static AssetLink findByE1_First(long entryId1,
		OrderByComparator<AssetLink> orderByComparator)
		throws com.liferay.asset.exception.NoSuchLinkException {
	...
	*/
	...
	private static ServiceTracker<AssetLinkPersistence, AssetLinkPersistence> _serviceTracker =
		ServiceTrackerFactory.open(AssetLinkPersistence.class);
}