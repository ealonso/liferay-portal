 ...
 * @see com.liferay.asset.categories.service.persistence.impl.AssetCategoryPropertyPersistenceImpl
 * @generated
 */
@ProviderType
public class AssetCategoryPropertyUtil {
	...
	*/
	public static AssetCategoryProperty findByCompanyId_First(long companyId,
		OrderByComparator<AssetCategoryProperty> orderByComparator)
		throws com.liferay.asset.categories.exception.NoSuchCategoryPropertyException {
		return getPersistence()
	...
	*/
	...
	private static ServiceTracker<AssetCategoryPropertyPersistence, AssetCategoryPropertyPersistence> _serviceTracker =
		ServiceTrackerFactory.open(AssetCategoryPropertyPersistence.class);
}