...
page import="com.liferay.asset.reader.ClassType" %><%@
page import="com.liferay.asset.reader.ClassTypeReader" %><%@
page import="com.liferay.asset.reader.exception.NoSuchClassTypeException" %><%@
