            ...
            var AssetTaglibCategoriesSelector = A.Component.create(
                    {
                        ...
                        prototype: {
                            ...
                            _showPopup: function(event) {
                                ...
                                AssetTaglibCategoriesSelector.superclass._showPopup.apply(instance, arguments);
                            },
                            ...
                            _showSelectPopup: function(event) {
                                ...
                                uri = Liferay.Util.addParams(instance.get('namespace') + 'selectedCategories=' + instance.entries.keys.join(), uri);
