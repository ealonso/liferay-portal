...
public class AssetCategoryServiceHttp {
	public static com.liferay.asset.categories.model.AssetCategory addCategory(
		...
		try {
			...
			return (com.liferay.asset.categories.model.AssetCategory)returnObj;
		}
	...
	public static java.util.List<com.liferay.asset.categories.model.AssetCategory> deleteCategories(
		...
		try {
			...
			return (java.util.List<com.liferay.asset.categories.model.AssetCategory>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.liferay.asset.categories.model.AssetCategoryDisplay getVocabularyCategoriesDisplay(
		...
		try {
			...
			return (com.liferay.asset.categories.model.AssetCategoryDisplay)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
