...
public class AssetCategoryPropertyServiceHttp {
	public static com.liferay.asset.categories.model.AssetCategoryProperty addCategoryProperty(
		...
		try {
			...
			return (com.liferay.asset.categories.model.AssetCategoryProperty)returnObj;
		}
	...
	public static java.util.List<com.liferay.asset.categories.model.AssetCategoryProperty> getCategoryProperties(
		...
		try {
			...
			return (java.util.List<com.liferay.asset.categories.model.AssetCategoryProperty>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
