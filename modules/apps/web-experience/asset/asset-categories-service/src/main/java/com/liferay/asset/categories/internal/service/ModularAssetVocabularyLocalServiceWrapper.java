...
public class ModularAssetVocabularyLocalServiceWrapper
	...
	public List<AssetVocabulary> getGroupVocabularies(
		...
		return ModelAdapterUtil.adapt(
			...
			_assetVocabularyLocalService.getGroupVocabularies(
				...
				new AssetVocabularyEntryOrderByComparatorAdapter(obc)));
	}
	...
	private static class AssetVocabularyEntryOrderByComparatorAdapter
		extends
			OrderByComparatorAdapter
				<com.liferay.asset.categories.model.AssetVocabulary,
					AssetVocabulary> {

		public AssetVocabularyEntryOrderByComparatorAdapter(
