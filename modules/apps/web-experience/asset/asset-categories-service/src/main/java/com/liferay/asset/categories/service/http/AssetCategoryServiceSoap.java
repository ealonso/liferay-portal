...
package com.liferay.asset.categories.service.http;
 ...
 * is translated to an array of {@link com.liferay.asset.categories.model.AssetCategorySoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.asset.categories.model.AssetCategory}, that is translated to a
 * {@link com.liferay.asset.categories.model.AssetCategorySoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.asset.categories.model.AssetCategorySoap
 * @see AssetCategoryServiceUtil
 * @generated
 */
@ProviderType
public class AssetCategoryServiceSoap {
	public static com.liferay.asset.categories.model.AssetCategorySoap addCategory(
		...
		try {
			...
			com.liferay.asset.categories.model.AssetCategory returnValue = AssetCategoryServiceUtil.addCategory(groupId,
					parentCategoryId, titleMap, descriptionMap, vocabularyId,
					categoryProperties, serviceContext);

			return com.liferay.asset.categories.model.AssetCategorySoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	*/
	@Deprecated
	public static com.liferay.asset.categories.model.AssetCategorySoap[] deleteCategories(
		long[] categoryIds,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws RemoteException {
		try {
			java.util.List<com.liferay.asset.categories.model.AssetCategory> returnValue =
				AssetCategoryServiceUtil.deleteCategories(categoryIds,
					serviceContext);

			return com.liferay.asset.categories.model.AssetCategorySoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap fetchCategory(
		long categoryId) throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategory returnValue = AssetCategoryServiceUtil.fetchCategory(categoryId);
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap[] getCategories(
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap getCategory(
		long categoryId) throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategory returnValue = AssetCategoryServiceUtil.getCategory(categoryId);
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap[] getChildCategories(
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap[] getVocabularyCategories(
	...
	public static com.liferay.asset.categories.model.AssetCategoryDisplay getVocabularyCategoriesDisplay(
		long vocabularyId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.asset.categories.model.AssetCategory> obc)
		throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategoryDisplay returnValue = AssetCategoryServiceUtil.getVocabularyCategoriesDisplay(vocabularyId,
					start, end, obc);
	...
	public static com.liferay.asset.categories.model.AssetCategoryDisplay getVocabularyCategoriesDisplay(
		...
		throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategoryDisplay returnValue = AssetCategoryServiceUtil.getVocabularyCategoriesDisplay(groupId,
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap[] getVocabularyRootCategories(
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap moveCategory(
		long categoryId, long parentCategoryId, long vocabularyId,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategory returnValue = AssetCategoryServiceUtil.moveCategory(categoryId,
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap[] search(
	...
	public static com.liferay.asset.categories.model.AssetCategoryDisplay searchCategoriesDisplay(
		long groupId, java.lang.String title, long vocabularyId, int start,
		int end) throws RemoteException {
		try {
			com.liferay.asset.categories.model.AssetCategoryDisplay returnValue = AssetCategoryServiceUtil.searchCategoriesDisplay(groupId,
	...
	public static com.liferay.asset.categories.model.AssetCategoryDisplay searchCategoriesDisplay(
		...
		try {
			com.liferay.asset.categories.model.AssetCategoryDisplay returnValue = AssetCategoryServiceUtil.searchCategoriesDisplay(groupIds,
	...
	public static com.liferay.asset.categories.model.AssetCategorySoap updateCategory(
		...
		try {
			...
			com.liferay.asset.categories.model.AssetCategory returnValue = AssetCategoryServiceUtil.updateCategory(categoryId,
					parentCategoryId, titleMap, descriptionMap, vocabularyId,
					categoryProperties, serviceContext);
