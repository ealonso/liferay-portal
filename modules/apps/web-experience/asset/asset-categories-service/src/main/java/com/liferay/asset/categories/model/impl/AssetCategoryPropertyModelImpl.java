...
import com.liferay.asset.categories.model.AssetCategoryPropertyModel;
import com.liferay.asset.categories.model.AssetCategoryPropertySoap;
...
public class AssetCategoryPropertyModelImpl extends BaseModelImpl<AssetCategoryProperty>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.asset.categories.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.asset.categories.model.AssetCategoryProperty"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.asset.categories.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.asset.categories.model.AssetCategoryProperty"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.asset.categories.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.asset.categories.model.AssetCategoryProperty"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.asset.categories.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.asset.categories.model.AssetCategoryProperty"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.asset.categories.model.AssetCategoryProperty");
