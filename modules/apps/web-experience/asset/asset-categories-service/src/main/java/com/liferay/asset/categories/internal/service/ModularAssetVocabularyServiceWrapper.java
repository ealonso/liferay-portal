...
public class ModularAssetVocabularyServiceWrapper
	...
	public List<AssetVocabulary> getGroupVocabularies(
		...
		return ModelAdapterUtil.adapt(
			...
			_assetVocabularyService.getGroupVocabularies(
				...
				new AssetVocabularyOrderByComparatorAdapter(obc)));
	}
	...
	private static class AssetVocabularyOrderByComparatorAdapter
		extends
			OrderByComparatorAdapter
				<com.liferay.asset.categories.model.AssetVocabulary,
					AssetVocabulary> {

		public AssetVocabularyOrderByComparatorAdapter(
		...
		@Override
		public AssetVocabulary adapt(
			com.liferay.
				asset.categories.model.AssetVocabulary assetVocabulary) {

			return ModelAdapterUtil.adapt(
				AssetVocabulary.class, assetVocabulary);
		}
