...
public class ModularAssetCategoryLocalServiceWrapper
	...
	public List<AssetCategory> getChildCategories(
		...
		return ModelAdapterUtil.adapt(
			...
			_assetCategoryLocalService.getChildCategories(
				...
				new AssetCategoryEntryOrderByComparatorAdapter(obc)));
	}
	...
	private static class AssetCategoryEntryOrderByComparatorAdapter
		extends
			OrderByComparatorAdapter
				<com.liferay.asset.categories.model.AssetCategory,
					AssetCategory> {

		public AssetCategoryEntryOrderByComparatorAdapter(
