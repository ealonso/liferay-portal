...
public class AssetEntryServiceHttp {
	public static com.liferay.asset.model.AssetEntry fetchEntry(
		...
		try {
			...
			return (com.liferay.asset.model.AssetEntry)returnObj;
		}
	...
	public static java.util.List<com.liferay.asset.model.AssetEntry> getCompanyEntries(
		...
		try {
			...
			return (java.util.List<com.liferay.asset.model.AssetEntry>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _incrementViewCounterParameterTypes6 = new Class[] {
			com.liferay.asset.model.AssetEntry.class
		};
