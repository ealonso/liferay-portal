...
public class AssetCategoryServiceHttp {
	public static com.liferay.asset.model.AssetCategory addCategory(
		...
		try {
			...
			return (com.liferay.asset.model.AssetCategory)returnObj;
		}
	...
	public static java.util.List<com.liferay.asset.model.AssetCategory> deleteCategories(
		...
		try {
			...
			return (java.util.List<com.liferay.asset.model.AssetCategory>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.liferay.asset.model.AssetCategoryDisplay getVocabularyCategoriesDisplay(
		...
		try {
			...
			return (com.liferay.asset.model.AssetCategoryDisplay)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
