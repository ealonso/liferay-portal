 ...
 * @see com.liferay.asset.service.persistence.AssetEntryUtil
 * @generated
 */
@ProviderType
public class AssetEntryPersistenceImpl extends BasePersistenceImpl<AssetEntry>
	 ...
	 */
	@Override
	public List<com.liferay.asset.model.AssetCategory> getAssetCategories(
		long pk) {
	...
	public List<com.liferay.asset.model.AssetCategory> getAssetCategories(
		long pk, int start, int end,
		OrderByComparator<com.liferay.asset.model.AssetCategory> orderByComparator) {
	...
	public void addAssetCategories(long pk,
		List<com.liferay.asset.model.AssetCategory> assetCategories) {
		addAssetCategories(pk,
			ListUtil.toLongArray(assetCategories,
				com.liferay.asset.model.AssetCategory.CATEGORY_ID_ACCESSOR));
	}
	...
	public void setAssetCategories(long pk,
		...
		try {
			...
			for (int i = 0; i < assetCategories.size(); i++) {
				com.liferay.asset.model.AssetCategory assetCategory = assetCategories.get(i);
	 ...
	 */
	@Override
	public List<com.liferay.asset.model.AssetTag> getAssetTags(long pk) {
	...
	public List<com.liferay.asset.model.AssetTag> getAssetTags(long pk,
		int start, int end,
		OrderByComparator<com.liferay.asset.model.AssetTag> orderByComparator) {
	 ...
	 */
	@Override
	public void addAssetTag(long pk, com.liferay.asset.model.AssetTag assetTag) {
		AssetEntry assetEntry = fetchByPrimaryKey(pk);
	...
	public void addAssetTags(long pk,
		List<com.liferay.asset.model.AssetTag> assetTags) {
		addAssetTags(pk,
			ListUtil.toLongArray(assetTags,
				com.liferay.asset.model.AssetTag.TAG_ID_ACCESSOR));
	}
	...
	public void setAssetTags(long pk,
		...
		try {
			...
			for (int i = 0; i < assetTags.size(); i++) {
				com.liferay.asset.model.AssetTag assetTag = assetTags.get(i);
	...
	protected TableMapper<AssetEntry, com.liferay.asset.model.AssetCategory> assetEntryToAssetCategoryTableMapper;
	@BeanReference(type = AssetTagPersistence.class)
	protected AssetTagPersistence assetTagPersistence;
	protected TableMapper<AssetEntry, com.liferay.asset.model.AssetTag> assetEntryToAssetTagTableMapper;
