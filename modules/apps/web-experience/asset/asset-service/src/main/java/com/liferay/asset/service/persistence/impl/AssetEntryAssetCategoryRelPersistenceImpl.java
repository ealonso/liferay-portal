...
import com.liferay.asset.exception.NoSuchEntryAssetCategoryRelException;
import com.liferay.asset.model.AssetEntryAssetCategoryRel;
import com.liferay.asset.model.impl.AssetEntryAssetCategoryRelImpl;
import com.liferay.asset.model.impl.AssetEntryAssetCategoryRelModelImpl;
 ...
 * @see com.liferay.asset.service.persistence.AssetEntryAssetCategoryRelUtil
 * @generated
 */
@ProviderType
public class AssetEntryAssetCategoryRelPersistenceImpl
	 ...
	 *
	 * @param entryId the primary key of the current asset entry asset category rel
	 * @param assetEntryId the asset entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public AssetEntryAssetCategoryRel[] findByAssetEntryId_PrevAndNext(
		...
		OrderByComparator<AssetEntryAssetCategoryRel> orderByComparator)
		throws NoSuchEntryAssetCategoryRelException {
		AssetEntryAssetCategoryRel assetEntryAssetCategoryRel = findByPrimaryKey(entryId);
	...
	public AssetEntryAssetCategoryRel[] findByAssetCategoryId_PrevAndNext(
		long entryId, long assetCategoryId,
		OrderByComparator<AssetEntryAssetCategoryRel> orderByComparator)
		throws NoSuchEntryAssetCategoryRelException {
		AssetEntryAssetCategoryRel assetEntryAssetCategoryRel = findByPrimaryKey(entryId);
	 ...
	 */
	@Override
	public AssetEntryAssetCategoryRel create(long entryId) {
		...
		assetEntryAssetCategoryRel.setPrimaryKey(entryId);

		assetEntryAssetCategoryRel.setCompanyId(companyProvider.getCompanyId());
	 ...
	 */
	@Override
	public AssetEntryAssetCategoryRel remove(long entryId)
		throws NoSuchEntryAssetCategoryRelException {
	...
	protected AssetEntryAssetCategoryRel toUnwrappedModel(
		...
		assetEntryAssetCategoryRelImpl.setCompanyId(assetEntryAssetCategoryRel.getCompanyId());
	 ...
	 */
	@Override
	public AssetEntryAssetCategoryRel findByPrimaryKey(long entryId)
		throws NoSuchEntryAssetCategoryRelException {
	 ...
	 */
	@Override
	public AssetEntryAssetCategoryRel fetchByPrimaryKey(long entryId) {
	...
	private static final String _SQL_SELECT_ASSETENTRYASSETCATEGORYREL_WHERE_PKS_IN =
		"SELECT assetEntryAssetCategoryRel FROM AssetEntryAssetCategoryRel assetEntryAssetCategoryRel WHERE entryId IN (";
