...
import com.liferay.asset.exception.NoSuchCategoryException;
 ...
 * @see com.liferay.asset.service.persistence.AssetCategoryUtil
 * @generated
 */
@ProviderType
public class AssetCategoryPersistenceImpl extends BasePersistenceImpl<AssetCategory>
	 ...
	 */
	@Override
	public List<com.liferay.asset.model.AssetEntry> getAssetEntries(long pk) {
	...
	public void addAssetEntries(long pk,
		...
		addAssetEntries(pk,
			ListUtil.toLongArray(assetEntries,
				com.liferay.asset.model.AssetEntry.ENTRY_ID_ACCESSOR));
	}
	...
	public void setAssetEntries(long pk,
		...
		try {
			...
			for (int i = 0; i < assetEntries.size(); i++) {
				com.liferay.asset.model.AssetEntry assetEntry = assetEntries.get(i);
	...
	protected TableMapper<AssetCategory, com.liferay.asset.model.AssetEntry> assetCategoryToAssetEntryTableMapper;
