...
public class AssetDisplayTemplateCacheModel implements CacheModel<AssetDisplayTemplate>,
	...
	public boolean equals(Object obj) {
		...
		if ((assetDisplayTemplateId == assetDisplayTemplateCacheModel.assetDisplayTemplateId) &&
				(mvccVersion == assetDisplayTemplateCacheModel.mvccVersion)) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		int hashCode = HashUtil.hash(0, assetDisplayTemplateId);
	...
	public AssetDisplayTemplate toEntityModel() {
		...
		assetDisplayTemplateImpl.setMvccVersion(mvccVersion);

		if (uuid == null) {
			assetDisplayTemplateImpl.setUuid(StringPool.BLANK);
		}
		else {
			assetDisplayTemplateImpl.setUuid(uuid);
		}
