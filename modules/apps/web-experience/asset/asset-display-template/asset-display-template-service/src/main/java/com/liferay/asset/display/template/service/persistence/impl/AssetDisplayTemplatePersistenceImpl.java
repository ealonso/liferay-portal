...
public class AssetDisplayTemplatePersistenceImpl extends BasePersistenceImpl<AssetDisplayTemplate>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED,
			AssetDisplayTemplateImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED,
			AssetDisplayTemplateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			AssetDisplayTemplateModelImpl.UUID_COLUMN_BITMASK |
			AssetDisplayTemplateModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
			new String[] { String.class.getName() });

	/**
	 * Returns all the asset display templates where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @return the matching asset display templates
	 */
	@Override
	public List<AssetDisplayTemplate> findByUuid(String uuid) {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset display templates where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<AssetDisplayTemplate> findByUuid(String uuid, int start, int end) {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the asset display templates where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link AssetDisplayTemplateModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<AssetDisplayTemplate> findByUuid(String uuid, int start,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AssetDisplayTemplate assetDisplayTemplate : list) {
					if (!Objects.equals(uuid, assetDisplayTemplate.getUuid())) {
						list = null;
	...
	/**
	 * Returns the first asset display template in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public AssetDisplayTemplate findByUuid_First(String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetDisplayTemplate fetchByUuid_First(String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator) {
		List<AssetDisplayTemplate> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last asset display template in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AssetDisplayTemplate findByUuid_Last(String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetDisplayTemplate fetchByUuid_Last(String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator) {
		...
		List<AssetDisplayTemplate> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the asset display templates before and after the current asset display template in the ordered set where uuid = &#63;.
	 *
	 ...
	 */
	@Override
	public AssetDisplayTemplate[] findByUuid_PrevAndNext(
		long assetDisplayTemplateId, String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, assetDisplayTemplate,
					uuid, orderByComparator, true);

			array[1] = assetDisplayTemplate;

			array[2] = getByUuid_PrevAndNext(session, assetDisplayTemplate,
	...
	protected AssetDisplayTemplate getByUuid_PrevAndNext(Session session,
		AssetDisplayTemplate assetDisplayTemplate, String uuid,
		OrderByComparator<AssetDisplayTemplate> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the asset display templates where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 */
	@Override
	public void removeByUuid(String uuid) {
		for (AssetDisplayTemplate assetDisplayTemplate : findByUuid(uuid,
	...
	/**
	 * Returns the number of asset display templates where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "assetDisplayTemplate.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "assetDisplayTemplate.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(assetDisplayTemplate.uuid IS NULL OR assetDisplayTemplate.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED,
			AssetDisplayTemplateImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			AssetDisplayTemplateModelImpl.UUID_COLUMN_BITMASK |
			AssetDisplayTemplateModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() });

	/**
	 * Returns the asset display template where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchDisplayTemplateException} if it could not be found.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the matching asset display template
	 * @throws NoSuchDisplayTemplateException if a matching asset display template could not be found
	 */
	@Override
	public AssetDisplayTemplate findByUUID_G(String uuid, long groupId)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = fetchByUUID_G(uuid, groupId);
	...
	/**
	 * Returns the asset display template where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the matching asset display template, or <code>null</code> if a matching asset display template could not be found
	 */
	@Override
	public AssetDisplayTemplate fetchByUUID_G(String uuid, long groupId) {
		return fetchByUUID_G(uuid, groupId, true);
	}

	/**
	 * Returns the asset display template where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @param retrieveFromCache whether to retrieve from the finder cache
	...
	public AssetDisplayTemplate fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof AssetDisplayTemplate) {
			AssetDisplayTemplate assetDisplayTemplate = (AssetDisplayTemplate)result;

			if (!Objects.equals(uuid, assetDisplayTemplate.getUuid()) ||
					(groupId != assetDisplayTemplate.getGroupId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AssetDisplayTemplate assetDisplayTemplate = list.get(0);

					result = assetDisplayTemplate;

					cacheResult(assetDisplayTemplate);

					if ((assetDisplayTemplate.getUuid() == null) ||
							!assetDisplayTemplate.getUuid().equals(uuid) ||
							(assetDisplayTemplate.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, assetDisplayTemplate);
					}
				}
			}
			catch (Exception e) {
		...
		if (result instanceof List<?>) {
			...
			return (AssetDisplayTemplate)result;
		}
	}

	/**
	 * Removes the asset display template where uuid = &#63; and groupId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public AssetDisplayTemplate removeByUUID_G(String uuid, long groupId)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = findByUUID_G(uuid, groupId);

		return remove(assetDisplayTemplate);
	}

	/**
	 * Returns the number of asset display templates where uuid = &#63; and groupId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	 * @return the number of matching asset display templates
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "assetDisplayTemplate.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "assetDisplayTemplate.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(assetDisplayTemplate.uuid IS NULL OR assetDisplayTemplate.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "assetDisplayTemplate.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED,
			AssetDisplayTemplateImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			AssetDisplayTemplateModelImpl.UUID_COLUMN_BITMASK |
			AssetDisplayTemplateModelImpl.COMPANYID_COLUMN_BITMASK |
			AssetDisplayTemplateModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(AssetDisplayTemplateModelImpl.ENTITY_CACHE_ENABLED,
			AssetDisplayTemplateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() });

	/**
	 * Returns all the asset display templates where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<AssetDisplayTemplate> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset display templates where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link AssetDisplayTemplateModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the asset display templates where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link AssetDisplayTemplateModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetDisplayTemplate> findByUuid_C(String uuid, long companyId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AssetDisplayTemplate assetDisplayTemplate : list) {
					if (!Objects.equals(uuid, assetDisplayTemplate.getUuid()) ||
							(companyId != assetDisplayTemplate.getCompanyId())) {
						list = null;
	...
	/**
	 * Returns the first asset display template in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AssetDisplayTemplate findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public AssetDisplayTemplate fetchByUuid_C_First(String uuid,
		long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator) {
		List<AssetDisplayTemplate> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last asset display template in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AssetDisplayTemplate findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = fetchByUuid_C_Last(uuid,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public AssetDisplayTemplate fetchByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator) {
		...
		List<AssetDisplayTemplate> list = findByUuid_C(uuid, companyId,
	...
	/**
	 * Returns the asset display templates before and after the current asset display template in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param assetDisplayTemplateId the primary key of the current asset display template
	 * @param uuid the uuid
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public AssetDisplayTemplate[] findByUuid_C_PrevAndNext(
		long assetDisplayTemplateId, String uuid, long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator)
		throws NoSuchDisplayTemplateException {
		AssetDisplayTemplate assetDisplayTemplate = findByPrimaryKey(assetDisplayTemplateId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, assetDisplayTemplate,
					uuid, companyId, orderByComparator, true);

			array[1] = assetDisplayTemplate;

			array[2] = getByUuid_C_PrevAndNext(session, assetDisplayTemplate,
	...
	protected AssetDisplayTemplate getByUuid_C_PrevAndNext(Session session,
		AssetDisplayTemplate assetDisplayTemplate, String uuid, long companyId,
		OrderByComparator<AssetDisplayTemplate> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the asset display templates where uuid = &#63; and companyId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 */
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (AssetDisplayTemplate assetDisplayTemplate : findByUuid_C(uuid,
	...
	/**
	 * Returns the number of asset display templates where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the number of matching asset display templates
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "assetDisplayTemplate.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "assetDisplayTemplate.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(assetDisplayTemplate.uuid IS NULL OR assetDisplayTemplate.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "assetDisplayTemplate.companyId = ?";
	...
	public void clearCache(AssetDisplayTemplate assetDisplayTemplate) {
		...
		clearUniqueFindersCache((AssetDisplayTemplateModelImpl)assetDisplayTemplate,
			true);
	}
	...
	protected void cacheUniqueFindersCache(
		AssetDisplayTemplateModelImpl assetDisplayTemplateModelImpl) {
		Object[] args = new Object[] {
				assetDisplayTemplateModelImpl.getUuid(),
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G, args,
			assetDisplayTemplateModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((assetDisplayTemplateModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					assetDisplayTemplateModelImpl.getOriginalUuid(),
	...
	public AssetDisplayTemplate create(long assetDisplayTemplateId) {
		...
		assetDisplayTemplate.setUuid(uuid);
	...
	public AssetDisplayTemplate updateImpl(
		...
		if (Validator.isNull(assetDisplayTemplate.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!AssetDisplayTemplateModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { assetDisplayTemplateModelImpl.getUuid() };
			...
			args = new Object[] {
					assetDisplayTemplateModelImpl.getUuid(),
					assetDisplayTemplateModelImpl.getCompanyId()
				};
			...
			if ((assetDisplayTemplateModelImpl.getColumnBitmask() &
				...
				args = new Object[] { assetDisplayTemplateModelImpl.getUuid() };
			...
			if ((assetDisplayTemplateModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						assetDisplayTemplateModelImpl.getOriginalUuid(),
						assetDisplayTemplateModelImpl.getOriginalCompanyId()
					};
		...
		clearUniqueFindersCache(assetDisplayTemplateModelImpl, false);
		cacheUniqueFindersCache(assetDisplayTemplateModelImpl);
	...
	protected AssetDisplayTemplate toUnwrappedModel(
		...
		assetDisplayTemplateImpl.setMvccVersion(assetDisplayTemplate.getMvccVersion());
		assetDisplayTemplateImpl.setUuid(assetDisplayTemplate.getUuid());
