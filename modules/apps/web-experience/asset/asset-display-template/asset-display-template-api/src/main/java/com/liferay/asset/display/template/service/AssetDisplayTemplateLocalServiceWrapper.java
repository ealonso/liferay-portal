...
public class AssetDisplayTemplateLocalServiceWrapper
	...
	*/
	...
	/**
	* Returns the asset display template matching the UUID and group.
	*
	* @param uuid the asset display template's UUID
	...
	*/
	@Override
	public com.liferay.asset.display.template.model.AssetDisplayTemplate fetchAssetDisplayTemplateByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return _assetDisplayTemplateLocalService.fetchAssetDisplayTemplateByUuidAndGroupId(uuid,
			groupId);
	}
	...
	* @throws PortalException if a matching asset display template could not be found
	*/
	@Override
	public com.liferay.asset.display.template.model.AssetDisplayTemplate getAssetDisplayTemplateByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetDisplayTemplateLocalService.getAssetDisplayTemplateByUuidAndGroupId(uuid,
			groupId);
	}
	...
	*/
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		return _assetDisplayTemplateLocalService.getExportActionableDynamicQuery(portletDataContext);
	}
	...
	*/
	...
	/**
	* Returns all the asset display templates matching the UUID and company.
	*
	* @param uuid the UUID of the asset display templates
	* @param companyId the primary key of the company
	* @return the matching asset display templates, or an empty list if no matches were found
	*/
	@Override
	public java.util.List<com.liferay.asset.display.template.model.AssetDisplayTemplate> getAssetDisplayTemplatesByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return _assetDisplayTemplateLocalService.getAssetDisplayTemplatesByUuidAndCompanyId(uuid,
			companyId);
	}

	/**
	* Returns a range of asset display templates matching the UUID and company.
	*
	* @param uuid the UUID of the asset display templates
	* @param companyId the primary key of the company
	* @param start the lower bound of the range of asset display templates
	* @param end the upper bound of the range of asset display templates (not inclusive)
	* @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	* @return the range of matching asset display templates, or an empty list if no matches were found
	*/
	@Override
	public java.util.List<com.liferay.asset.display.template.model.AssetDisplayTemplate> getAssetDisplayTemplatesByUuidAndCompanyId(
