...
public class AssetDisplayTemplateWrapper implements AssetDisplayTemplate,
	...
	*/
	...
	/**
	* Returns <code>true</code> if this asset display template is in the Recycle Bin.
	*
	* @return <code>true</code> if this asset display template is in the Recycle Bin; <code>false</code> otherwise
	*/
	@Override
	public boolean isInTrash() {
		return _assetDisplayTemplate.isInTrash();
	}

	/**
	* Returns <code>true</code> if the parent of this asset display template is in the Recycle Bin.
	*
	* @return <code>true</code> if the parent of this asset display template is in the Recycle Bin; <code>false</code> otherwise
	*/
	@Override
	public boolean isInTrashContainer() {
		return _assetDisplayTemplate.isInTrashContainer();
	}

	@Override
	public boolean isInTrashExplicitly() {
		return _assetDisplayTemplate.isInTrashExplicitly();
	}

	@Override
	public boolean isInTrashImplicitly() {
		return _assetDisplayTemplate.isInTrashImplicitly();
	}
	...
	*/
	...
	/**
	* Returns the trash handler for this asset display template.
	*
	* @return the trash handler for this asset display template
	* @deprecated As of 7.0.0, with no direct replacement
	*/
	@Deprecated
	@Override
	public com.liferay.portal.kernel.trash.TrashHandler getTrashHandler() {
		return _assetDisplayTemplate.getTrashHandler();
	}

	/**
	* Returns the trash entry created when this asset display template was moved to the Recycle Bin. The trash entry may belong to one of the ancestors of this asset display template.
	*
	* @return the trash entry created when this asset display template was moved to the Recycle Bin
	*/
	@Override
	public com.liferay.trash.kernel.model.TrashEntry getTrashEntry()
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetDisplayTemplate.getTrashEntry();
	}
	...
	/**
	* Returns the status of this asset display template.
	*
	* @return the status of this asset display template
	*/
	@Override
	public int getStatus() {
		return _assetDisplayTemplate.getStatus();
	}
	...
	*/
	...
	/**
	* Returns the uuid of this asset display template.
	*
	* @return the uuid of this asset display template
	*/
	@Override
	public java.lang.String getUuid() {
		return _assetDisplayTemplate.getUuid();
	}
	...
	*/
	...
	/**
	* Returns the mvcc version of this asset display template.
	*
	* @return the mvcc version of this asset display template
	*/
	@Override
	public long getMvccVersion() {
		return _assetDisplayTemplate.getMvccVersion();
	}
	...
	*/
	...
	/**
	* Returns the class primary key of the trash entry for this asset display template.
	*
	* @return the class primary key of the trash entry for this asset display template
	*/
	@Override
	public long getTrashEntryClassPK() {
		return _assetDisplayTemplate.getTrashEntryClassPK();
	}
	...
	*/
	...
	/**
	* Sets the mvcc version of this asset display template.
	*
	* @param mvccVersion the mvcc version of this asset display template
	*/
	@Override
	public void setMvccVersion(long mvccVersion) {
		_assetDisplayTemplate.setMvccVersion(mvccVersion);
	}
	...
	*/
	...
	/**
	* Sets the uuid of this asset display template.
	*
	* @param uuid the uuid of this asset display template
	*/
	@Override
	public void setUuid(java.lang.String uuid) {
		_assetDisplayTemplate.setUuid(uuid);
	}
	...
	public StagedModelType getStagedModelType() {
		return _assetDisplayTemplate.getStagedModelType();
	}
