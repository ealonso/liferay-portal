...
import com.liferay.layout.item.selector.web.internal.display.context.DisplayPagesItemSelectorViewDisplayContext;
 ...
 */
@Component(
	property = "view=display-page",
	service = {DisplayPagesItemSelectorView.class, ItemSelectorView.class}
)
public class DisplayPagesItemSelectorView
	implements ItemSelectorView<DisplayPageSelectorCriterion> {
	...
	public void renderHTML(
		...
		DisplayPagesItemSelectorViewDisplayContext
			displayPagesItemSelectorViewDisplayContext =
				new DisplayPagesItemSelectorViewDisplayContext(
					request, _assetDisplayContributorTracker,
					displayPageSelectorCriterion, itemSelectedEventName,
					portletURL);
	...
	@Reference(
		target = "(bundle.symbolic.name=com.liferay.layout.item.selector.web)",
		unbind = "-"
	)
