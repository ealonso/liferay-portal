...
/**
 * Provides the local service interface for LayoutFragment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LayoutFragmentLocalServiceUtil
...
public interface LayoutFragmentLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutFragmentLocalServiceUtil} to access the layout fragment local service. Add custom service methods to {@link com.liferay.layout.service.service.impl.LayoutFragmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public LayoutFragment createLayoutFragment(long layoutFragmentId);
	...
	*/
	...
	public LayoutFragment fetchLayoutFragment(long layoutFragmentId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LayoutFragment getLayoutFragment(long layoutFragmentId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LayoutFragment> getLayoutFragments(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public LayoutFragment updateLayoutFragment(LayoutFragment layoutFragment);
}