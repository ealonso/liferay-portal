...
<div class="layout-edit-mode">
	<div class="container-fluid-1280">
		<liferay-ui:tabs
			...
			urls='<%= new String[] {HttpUtil.setParameter(contentURL, "p_p_edit", Boolean.TRUE.toString()), HttpUtil.setParameter(editLayoutURL.toString(), "p_p_edit", Boolean.TRUE.toString())} %>'
			value="<%= activeTab %>"
		/>
	</div>
</div>