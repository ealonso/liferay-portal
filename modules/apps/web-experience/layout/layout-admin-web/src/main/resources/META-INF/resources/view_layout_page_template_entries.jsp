...
<aui:script require="layout-admin-web/js/LayoutPageTemplateNameEditor">
	var layoutPageTemplateNameEditor;

	function handleAddLayoutPageTemplateEntryMenuItemClick (event) {
		event.preventDefault();

		layoutPageTemplateNameEditor = new layoutAdminWebJsLayoutPageTemplateNameEditor.default(
			{
