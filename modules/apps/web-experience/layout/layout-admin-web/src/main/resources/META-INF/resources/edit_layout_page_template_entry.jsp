...
layoutPageTemplateEditorContext.put("fragments", layoutPageTemplateDisplayContext.getLayoutPageTemplateFragments());
layoutPageTemplateEditorContext.put("fragmentCollections", layoutPageTemplateDisplayContext.getFragmentCollections());
layoutPageTemplateEditorContext.put("pageTemplateId", layoutPageTemplateDisplayContext.getLayoutPageTemplateEntryId());
...
<soy:template-renderer
	...
	module="layout-admin-web/js/LayoutPageTemplateEditor"
