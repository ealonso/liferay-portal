...
import './LayoutPageTemplateFragment';
import './LayoutPageTemplateFragmentCollection';
...
class LayoutPageTemplateEditor extends Component {
	...
	_updatePageTemplate () {
		...
		body.append(`${this.portletNamespace}layoutPageTemplateEntryId`, this.layoutPageTemplateEntryId);

		this.fragments.forEach((fragment) => {
			body.append(`${this.portletNamespace}fragmentIds`, fragment.id);
		});
