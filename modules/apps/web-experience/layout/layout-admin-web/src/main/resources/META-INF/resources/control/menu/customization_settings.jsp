	...
	<div class="control-menu-level-2">
		<div class="container-fluid-1280">
			...
			<ul class="control-menu-level-2-nav control-menu-nav">
				...
				resetCustomizationViewURL.setParameter(ActionRequest.ACTION_NAME, "/reset_customization_view");
				...
				toggleCustomizationViewPortletURL.setParameter(ActionRequest.ACTION_NAME, "/toggle_customized_view");
