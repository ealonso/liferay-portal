...
import com.liferay.layout.page.template.util.comparator.LayoutPageTemplateFolderCreateDateComparator;
import com.liferay.layout.page.template.util.comparator.LayoutPageTemplateFolderNameComparator;
...
public class PagesPortletUtil {
	...
	public static OrderByComparator<LayoutPageTemplateFolder>
		getLayoutPageTemplateFolderOrderByComparator(
			String orderByCol, String orderByType) {
		...
		OrderByComparator<LayoutPageTemplateFolder> orderByComparator = null;

		if (orderByCol.equals("create-date")) {
			orderByComparator =
				new LayoutPageTemplateFolderCreateDateComparator(orderByAsc);
		}
		else if (orderByCol.equals("name")) {
			orderByComparator = new LayoutPageTemplateFolderNameComparator(
				orderByAsc);
		}
