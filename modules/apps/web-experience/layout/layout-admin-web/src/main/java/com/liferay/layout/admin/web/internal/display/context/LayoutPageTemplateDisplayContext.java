...
import com.liferay.layout.admin.web.internal.util.FragmentsEditorHelper;
...
public class LayoutPageTemplateDisplayContext {
	...
	public JSONArray getFragmentCollectionsJSONArray() throws PortalException {
		return FragmentsEditorHelper.getFragmentCollectionsJSONArray(_request);
	}

	public JSONArray getFragmentEntryLinksJSONArray() throws PortalException {
		return FragmentsEditorHelper.getFragmentEntryLinksJSONArray(
			_request,
