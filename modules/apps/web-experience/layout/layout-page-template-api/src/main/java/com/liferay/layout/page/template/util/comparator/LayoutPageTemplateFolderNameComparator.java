 ...
 */
public class LayoutPageTemplateFolderNameComparator
	extends OrderByComparator<LayoutPageTemplateFolder> {

	public static final String ORDER_BY_ASC =
		"LayoutPageTemplateFolder.name ASC";

	public static final String ORDER_BY_DESC =
		"LayoutPageTemplateFolder.name DESC";

	public static final String[] ORDER_BY_FIELDS = {"name"};

	public LayoutPageTemplateFolderNameComparator() {
		this(false);
	}

	public LayoutPageTemplateFolderNameComparator(boolean ascending) {
	...
	public int compare(
		...
		String name1 = StringUtil.toLowerCase(
			layoutPageTemplateFolder1.getName());
		String name2 = StringUtil.toLowerCase(
			layoutPageTemplateFolder2.getName());
