...
public class ModularTrashEntryLocalServiceWrapper
	...
	public TrashEntry deleteEntry(long entryId) {
		return ModelAdapterUtil.adapt(
			TrashEntry.class, _trashEntryLocalService.deleteEntry(entryId));
	}
	...
	public TrashEntry fetchEntry(long entryId) {
		com.liferay.trash.model.TrashEntry trashVersion =
		...
		return ModelAdapterUtil.adapt(
			TrashEntry.class, _trashEntryLocalService.fetchEntry(entryId));
	}
	...
	public TrashEntry fetchTrashEntry(long entryId) {
		...
		return ModelAdapterUtil.adapt(
			TrashEntry.class, _trashEntryLocalService.fetchTrashEntry(entryId));
	}
