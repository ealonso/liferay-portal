 ...
 * is translated to an array of {@link com.liferay.trash.model.TrashEntrySoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.trash.model.TrashEntry}, that is translated to a
 * {@link com.liferay.trash.model.TrashEntrySoap}. Methods that SOAP cannot
 ...
 * @see com.liferay.trash.model.TrashEntrySoap
...
public class TrashEntryServiceSoap {
	...
	*/
	public static com.liferay.trash.model.TrashEntryList getEntries(
		...
		try {
			com.liferay.trash.model.TrashEntryList returnValue = TrashEntryServiceUtil.getEntries(groupId);
	...
	*/
	...
	public static com.liferay.trash.model.TrashEntrySoap[] getEntries(
		...
		try {
			java.util.List<com.liferay.trash.model.TrashEntry> returnValue = TrashEntryServiceUtil.getEntries(groupId,
					className);

			return com.liferay.trash.model.TrashEntrySoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	*/
	...
	public static com.liferay.trash.model.TrashEntrySoap restoreEntry(
		...
		try {
			com.liferay.trash.model.TrashEntry returnValue = TrashEntryServiceUtil.restoreEntry(entryId);

			return com.liferay.trash.model.TrashEntrySoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	*/
	...
	public static com.liferay.trash.model.TrashEntrySoap restoreEntry(
		...
		try {
			com.liferay.trash.model.TrashEntry returnValue = TrashEntryServiceUtil.restoreEntry(className,
					classPK);
