...
<aui:form action="<%= editArticleActionURL %>" cssClass="container-fluid-1280" enctype="multipart/form-data" method="post" name="fm1" onSubmit="event.preventDefault();">
	...
	<div class="lfr-form-content">
		...
		boolean hasInheritedWorkflowDefinitionLink = true;
		...
		if (inheritedWorkflowDDMStructuresFolderId > 0) {
			...
			hasInheritedWorkflowDefinitionLink = (inheritedWorkflowDDMStructuresFolder.getRestrictionType() == JournalFolderConstants.RESTRICTION_TYPE_INHERIT) && WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(themeDisplay.getCompanyId(), groupId, JournalArticle.class.getName());
		}
