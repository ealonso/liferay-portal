...
if (ddmStructureId > 0) {
	...
	ddmStructure = DDMStructureLocalServiceUtil.fetchStructure(PortalUtil.getSiteGroupId(article.getGroupId()), PortalUtil.getClassNameId(JournalArticle.class), ddmStructureKey, true);
}
...
if (ddmTemplateId > 0) {
	...
	ddmTemplate = DDMTemplateLocalServiceUtil.fetchTemplate(PortalUtil.getSiteGroupId(article.getGroupId()), PortalUtil.getClassNameId(DDMStructure.class), ddmTemplateKey, true);
}
