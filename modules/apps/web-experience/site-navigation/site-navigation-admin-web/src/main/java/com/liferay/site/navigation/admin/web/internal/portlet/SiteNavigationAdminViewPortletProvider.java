...
@Component(
	immediate = true,
	property = {
		"model.class.name=com.liferay.site.navigation.model.SiteNavigationMenu"
	},
	service = ViewPortletProvider.class
)
public class SiteNavigationAdminViewPortletProvider
	...
	public PortletURL getPortletURL(HttpServletRequest request)
		...
		portletURL.setParameter("showAddMenuItemButton", String.valueOf(false));
