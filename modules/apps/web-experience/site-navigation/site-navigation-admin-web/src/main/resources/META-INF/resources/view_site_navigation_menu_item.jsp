...
data.put("id", siteNavigationMenuItemId);
data.put("parentId", siteNavigationMenuItem.getParentSiteNavigationMenuItemId());
%>

<div class="<%= indent ? "indent" : "" %> container-item">
	<div class="col-md-3 site-navigation-menu-item <%= selectedSiteNavigationMenuItemId == siteNavigationMenuItemId ? "selected" : "" %>" <%= AUIUtil.buildData(data) %>>
