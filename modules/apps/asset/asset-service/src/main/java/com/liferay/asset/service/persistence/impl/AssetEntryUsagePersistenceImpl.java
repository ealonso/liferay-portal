...
public class AssetEntryUsagePersistenceImpl extends BasePersistenceImpl<AssetEntryUsage>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByA_H",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryUsageImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA_H",
			new String[] { Long.class.getName(), Boolean.class.getName() },
			AssetEntryUsageModelImpl.ASSETENTRYID_COLUMN_BITMASK |
			AssetEntryUsageModelImpl.HIDDEN_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_A_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_H",
			new String[] { Long.class.getName(), Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<AssetEntryUsage> findByA_H(long assetEntryId, boolean hidden) {
		return findByA_H(assetEntryId, hidden, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<AssetEntryUsage> findByA_H(long assetEntryId, boolean hidden,
		int start, int end) {
		return findByA_H(assetEntryId, hidden, start, end, null);
	}
	...
	public List<AssetEntryUsage> findByA_H(long assetEntryId, boolean hidden,
		int start, int end, OrderByComparator<AssetEntryUsage> orderByComparator) {
		return findByA_H(assetEntryId, hidden, start, end, orderByComparator,
			true);
	}
	...
	public List<AssetEntryUsage> findByA_H(long assetEntryId, boolean hidden,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_H;
			finderArgs = new Object[] { assetEntryId, hidden };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_A_H;
			finderArgs = new Object[] {
					assetEntryId, hidden,
			...
			if ((list != null) && !list.isEmpty()) {
				for (AssetEntryUsage assetEntryUsage : list) {
					if ((assetEntryId != assetEntryUsage.getAssetEntryId()) ||
							(hidden != assetEntryUsage.isHidden())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_A_H_ASSETENTRYID_2);

			query.append(_FINDER_COLUMN_A_H_HIDDEN_2);
	 ...
	 */
	@Override
	public AssetEntryUsage findByA_H_First(long assetEntryId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator)
		throws NoSuchEntryUsageException {
		AssetEntryUsage assetEntryUsage = fetchByA_H_First(assetEntryId,
	 ...
	 */
	@Override
	public AssetEntryUsage fetchByA_H_First(long assetEntryId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator) {
		List<AssetEntryUsage> list = findByA_H(assetEntryId, hidden, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryUsage findByA_H_Last(long assetEntryId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator)
		throws NoSuchEntryUsageException {
		AssetEntryUsage assetEntryUsage = fetchByA_H_Last(assetEntryId, hidden,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryUsage fetchByA_H_Last(long assetEntryId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator) {
		int count = countByA_H(assetEntryId, hidden);

		if (count == 0) {
			return null;
		}

		List<AssetEntryUsage> list = findByA_H(assetEntryId, hidden, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryUsage[] findByA_H_PrevAndNext(long assetEntryUsageId,
		...
		try {
			...
			array[0] = getByA_H_PrevAndNext(session, assetEntryUsage,
					assetEntryId, hidden, orderByComparator, true);

			array[1] = assetEntryUsage;

			array[2] = getByA_H_PrevAndNext(session, assetEntryUsage,
					assetEntryId, hidden, orderByComparator, false);
	...
	protected AssetEntryUsage getByA_H_PrevAndNext(Session session,
		AssetEntryUsage assetEntryUsage, long assetEntryId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByA_H(long assetEntryId, boolean hidden) {
		for (AssetEntryUsage assetEntryUsage : findByA_H(assetEntryId, hidden,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(assetEntryUsage);
		}
	}
	 ...
	 */
	@Override
	public int countByA_H(long assetEntryId, boolean hidden) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_A_H;

		Object[] finderArgs = new Object[] { assetEntryId, hidden };
	...
	private static final String _FINDER_COLUMN_A_H_ASSETENTRYID_2 = "assetEntryUsage.assetEntryId = ? AND ";
	private static final String _FINDER_COLUMN_A_H_HIDDEN_2 = "assetEntryUsage.hidden = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A_C_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryUsageImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByA_C_H",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_C_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryUsageImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA_C_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
			...
			AssetEntryUsageModelImpl.HIDDEN_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_A_C_H = new FinderPath(AssetEntryUsageModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryUsageModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByA_C_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	 ...
	 */
	@Override
	public List<AssetEntryUsage> findByA_C_H(long assetEntryId,
		long classNameId, boolean hidden) {
		return findByA_C_H(assetEntryId, classNameId, hidden,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<AssetEntryUsage> findByA_C_H(long assetEntryId,
		...
		return findByA_C_H(assetEntryId, classNameId, hidden, start, end, null);
	}
	...
	public List<AssetEntryUsage> findByA_C_H(long assetEntryId,
		long classNameId, boolean hidden, int start, int end,
		OrderByComparator<AssetEntryUsage> orderByComparator) {
		return findByA_C_H(assetEntryId, classNameId, hidden, start, end,
			orderByComparator, true);
	}
	...
	public List<AssetEntryUsage> findByA_C_H(long assetEntryId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_C_H;
			finderArgs = new Object[] { assetEntryId, classNameId, hidden };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_A_C_H;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_A_C_H_ASSETENTRYID_2);

			query.append(_FINDER_COLUMN_A_C_H_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_A_C_H_HIDDEN_2);
	 ...
	 */
	@Override
	public AssetEntryUsage findByA_C_H_First(long assetEntryId,
		long classNameId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator)
		throws NoSuchEntryUsageException {
		AssetEntryUsage assetEntryUsage = fetchByA_C_H_First(assetEntryId,
	 ...
	 */
	@Override
	public AssetEntryUsage fetchByA_C_H_First(long assetEntryId,
		long classNameId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator) {
		List<AssetEntryUsage> list = findByA_C_H(assetEntryId, classNameId,
	 ...
	 */
	@Override
	public AssetEntryUsage findByA_C_H_Last(long assetEntryId,
		long classNameId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator)
		throws NoSuchEntryUsageException {
		AssetEntryUsage assetEntryUsage = fetchByA_C_H_Last(assetEntryId,
				classNameId, hidden, orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryUsage fetchByA_C_H_Last(long assetEntryId,
		long classNameId, boolean hidden,
		OrderByComparator<AssetEntryUsage> orderByComparator) {
		int count = countByA_C_H(assetEntryId, classNameId, hidden);
	 ...
	 */
	@Override
	public AssetEntryUsage[] findByA_C_H_PrevAndNext(long assetEntryUsageId,
		...
		try {
			...
			array[0] = getByA_C_H_PrevAndNext(session, assetEntryUsage,
					assetEntryId, classNameId, hidden, orderByComparator, true);

			array[1] = assetEntryUsage;

			array[2] = getByA_C_H_PrevAndNext(session, assetEntryUsage,
					assetEntryId, classNameId, hidden, orderByComparator, false);
	...
	protected AssetEntryUsage getByA_C_H_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public void removeByA_C_H(long assetEntryId, long classNameId,
		boolean hidden) {
		for (AssetEntryUsage assetEntryUsage : findByA_C_H(assetEntryId,
				classNameId, hidden, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(assetEntryUsage);
		}
	}
	 ...
	 */
	@Override
	public int countByA_C_H(long assetEntryId, long classNameId, boolean hidden) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_A_C_H;

		Object[] finderArgs = new Object[] { assetEntryId, classNameId, hidden };
	...
	private static final String _FINDER_COLUMN_A_C_H_ASSETENTRYID_2 = "assetEntryUsage.assetEntryId = ? AND ";
	private static final String _FINDER_COLUMN_A_C_H_CLASSNAMEID_2 = "assetEntryUsage.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_A_C_H_HIDDEN_2 = "assetEntryUsage.hidden = ?";
	...
	public AssetEntryUsage updateImpl(AssetEntryUsage assetEntryUsage) {
		...
		if (!AssetEntryUsageModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					assetEntryUsageModelImpl.getAssetEntryId(),
					assetEntryUsageModelImpl.isHidden()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_A_H, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_H,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_A_C_H, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_C_H,
				args);
			...
			if ((assetEntryUsageModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						assetEntryUsageModelImpl.getOriginalAssetEntryId(),
						assetEntryUsageModelImpl.getOriginalHidden()
					};
			...
			if ((assetEntryUsageModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_C_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						assetEntryUsageModelImpl.getOriginalAssetEntryId(),
						assetEntryUsageModelImpl.getOriginalClassNameId(),
						assetEntryUsageModelImpl.getOriginalHidden()
