...
public class AssetLinkPersistenceImpl
	...
	public AssetLink fetchByE_E_T(
		...
		if (result == null) {
			...
			try {
				...
				finderCache.removeResult(_finderPathFetchByE_E_T, finderArgs);
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathCountByE_E_T, args);
			finderCache.removeResult(_finderPathFetchByE_E_T, args);
		}
	...
	public AssetLink updateImpl(AssetLink assetLink) {
		...
		if (!AssetLinkModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			finderCache.removeResult(_finderPathCountByE1, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByE1, args);

			args = new Object[] {assetLinkModelImpl.getEntryId2()};

			finderCache.removeResult(_finderPathCountByE2, args);
			finderCache.removeResult(
			...
			finderCache.removeResult(_finderPathCountByE_E, args);
			finderCache.removeResult(
			...
			finderCache.removeResult(_finderPathCountByE1_T, args);
			finderCache.removeResult(
			...
			finderCache.removeResult(_finderPathCountByE2_T, args);
			finderCache.removeResult(
	...
	private static final String _SQL_SELECT_ASSETLINK_WHERE_PKS_IN =
		"SELECT assetLink FROM AssetLink assetLink WHERE linkId IN (";
