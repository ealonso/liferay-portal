...
public class AssetListEntryModelImpl extends BaseModelImpl<AssetListEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table AssetListEntry (assetListEntryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,preferences TEXT null,title VARCHAR(75) null,type_ INTEGER)";
	...
	public Object clone() {
		...
		assetListEntryImpl.setPreferences(getPreferences());
	...
	public CacheModel<AssetListEntry> toCacheModel() {
		...
		assetListEntryCacheModel.preferences = getPreferences();

		String preferences = assetListEntryCacheModel.preferences;

		if ((preferences != null) && (preferences.length() == 0)) {
			assetListEntryCacheModel.preferences = null;
		}
