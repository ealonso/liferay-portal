...
public class SelectAssetListDisplayContext {
	...
	public String getAssetListEntryClearResultsURL() throws PortletException {
	...
	public String getAssetListEntrySearchActionURL() throws PortletException {
	...
	private PortletURL _getPortletURL() throws PortletException {
		PortletURL portletURL = PortletURLUtil.clone(
			_portletURL, _liferayPortletResponse);
