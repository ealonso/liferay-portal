...
public class AssetLinkLocalServiceUtil {
	 ...
	 */
	public static com.liferay.asset.link.model.AssetLink addLink(
	 ...
	 */
	public static java.util.List<com.liferay.asset.link.model.AssetLink>
	...
	private static ServiceTracker<AssetLinkLocalService, AssetLinkLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AssetLinkLocalService.class);

		ServiceTracker<AssetLinkLocalService, AssetLinkLocalService>
			serviceTracker =
				new ServiceTracker
					<AssetLinkLocalService, AssetLinkLocalService>(
						bundle.getBundleContext(), AssetLinkLocalService.class,
						null);
