...
public class AssetLinkUtil {
	...
	private static ServiceTracker<AssetLinkPersistence, AssetLinkPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(AssetLinkPersistence.class);

		ServiceTracker<AssetLinkPersistence, AssetLinkPersistence>
			serviceTracker =
				new ServiceTracker<AssetLinkPersistence, AssetLinkPersistence>(
					bundle.getBundleContext(), AssetLinkPersistence.class,
					null);
