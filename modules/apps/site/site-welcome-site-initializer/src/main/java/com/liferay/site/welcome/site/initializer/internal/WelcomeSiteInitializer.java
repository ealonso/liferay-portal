...
public class WelcomeSiteInitializer implements SiteInitializer {
	...
	public static final String KEY = "welcome-site-initializer";
	...
	private void _addDefaultGuestPublicLayout(long groupId)
		...
		try {
			_importDefaultLayoutDefinition(draftLayout, serviceContext);
	...
	private void _importDefaultLayoutDefinition(
	...
	private static final String _DEFAULT_LAYOUT_DEFINITION =
