...
@Component(
	...
	immediate = true, service = FFLayoutContentPageEditorConfigurationUtil.class
)
public class FFLayoutContentPageEditorConfigurationUtil {

	public static boolean responsiveEnabled() {
		return _ffLayoutContentPageEditorConfiguration.responsiveEnabled();
	}

	public static boolean undoEnabled() {
		return _ffLayoutContentPageEditorConfiguration.undoEnabled();
	}
