...
public abstract class ContentPageEditorDisplayContext {
	...
	protected abstract List<Map<String, Object>> getSidebarPanels();
	...
	private List<Map<String, Object>> _getDynamicFragments() {
		...
		Map<String, List<Map<String, Object>>> fragmentCollectionsMap =
			new HashMap<>();
		...
		for (Map.Entry<String, List<Map<String, Object>>> entry :
				fragmentCollectionsMap.entrySet()) {
	...
	private List<Map<String, Object>> _getFragmentCollectionContributors() {
		List<Map<String, Object>> filteredFragmentCollectionContributors =
			new ArrayList<>();
		...
		for (FragmentCollectionContributor fragmentCollectionContributor :
			...
			filteredFragmentCollectionContributors.add(
				HashMapBuilder.<String, Object>put(
		...
		return filteredFragmentCollectionContributors;
	}

	private List<Map<String, Object>> _getFragmentCollections(
		boolean includeEmpty, boolean includeSystem) {

		List<Map<String, Object>> filteredFragmentCollections =
			new ArrayList<>();

		if (includeSystem) {
			filteredFragmentCollections.addAll(
				_getFragmentCollectionContributors());
			filteredFragmentCollections.addAll(_getDynamicFragments());
		}
		...
		for (FragmentCollection fragmentCollection : fragmentCollections) {
			...
			filteredFragmentCollections.add(
				HashMapBuilder.<String, Object>put(
					"fragmentCollectionId",
					fragmentCollection.getFragmentCollectionId()
				).put(
		...
		return filteredFragmentCollections;
	}
	...
	private Map<String, Object> _getFragmentEntry(
		...
		if (Validator.isNotNull(rendererKey)) {
			Map<String, Object> contributedFragmentEntry =
				_getContributedFragmentEntry(rendererKey);

			if (!contributedFragmentEntry.isEmpty()) {
				return contributedFragmentEntry;
			}
		...
		try {
			for (FragmentEntryLink fragmentEntryLink : fragmentEntryLinks) {
				...
				fragmentRendererContext.setSegmentsExperienceIds(
					new long[] {getSegmentsExperienceId()});
