...
public class LayoutCrawlerTest {
	...
	public void setUp() throws Exception {
		...
		_fragmentEntryLinkService.addFragmentEntryLink(
			...
			segmentsExperienceId, _layout.getPlid(), fragmentEntry.getCss(),
			fragmentEntry.getHtml(), fragmentEntry.getJs(),
			fragmentEntry.getConfiguration(), null, StringPool.BLANK, 0, null,
			serviceContext);
		...
		FragmentEntryLink inlineFragmentEntryLink =
			_fragmentEntryLinkService.addFragmentEntryLink(
				...
				segmentsExperienceId, _layout.getPlid(),
		...
		FragmentEntryLink widgetFragmentEntryLink =
			_fragmentEntryLinkService.addFragmentEntryLink(
				_group.getGroupId(), 0, 0, segmentsExperienceId,
		...
		_layoutPageTemplateStructureLocalService.
			updateLayoutPageTemplateStructureData(
				_layout.getGroupId(), _layout.getPlid(), segmentsExperienceId,
