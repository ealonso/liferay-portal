...
page import="com.liferay.layout.page.template.admin.web.internal.util.LayoutPageTemplateCollectionsUtil" %><%@
...
page import="com.liferay.portal.kernel.feature.flag.FeatureFlag" %><%@
