...
<portlet:actionURL name="/layout/delete_layout_page_template_entry" var="deleteMasterPageURL">
...
<aui:form action="<%= deleteMasterPageURL %>" cssClass="container-fluid-1280" name="fm">
	...
	<liferay-ui:error key="<%= RequiredLayoutPageTemplateEntryException.class.getName() %>" message="you-cannot-delete-master-pages-that-are-used-by-one-or-more-pages" />
