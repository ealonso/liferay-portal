...
const ImportModal = ({importURL, portletNamespace}: Props) => {
				...
				>
					<ClayModal.Body>
						<p>
							...
							<ClayLink
								className="c-ml-1"
								href="https://learn.liferay.com/dxp/latest/en/site-building/creating-pages/adding-pages/exporting-and-importing-page-templates.html"
								target="_blank"
							>
								{Liferay.Language.get(
