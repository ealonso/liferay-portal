...
import com.liferay.layout.page.template.admin.web.internal.configuration.util.ImportExportLayoutPageTemplateConfigurationUtil;
		...
		return new DropdownItemList() {
			{
				...
				if (ImportExportLayoutPageTemplateConfigurationUtil.enabled()) {
					add(
