...
public class ExportLayoutUtilityPageEntriesMVCResourceCommand
	...
	public File getFile(long[] layoutUtilityPageEntryIds)
		...
		try {
			...
			return _layoutUtilityPageExporter.exportUtilityPages(
	...
	public String getFileName(long[] layoutUtilityPageEntryIds) {
	...
	public long[] getLayoutUtilityPageEntryIds(
	...
	public boolean serveResource(
		...
		long[] layoutUtilityPageEntryIds = getLayoutUtilityPageEntryIds(
			resourceRequest);
		...
		try {
			PortletResponseUtil.sendFile(
				...
				getFileName(layoutUtilityPageEntryIds),
				new FileInputStream(getFile(layoutUtilityPageEntryIds)),
	...
	@Reference
	private LayoutUtilityPageExporter _layoutUtilityPageExporter;
