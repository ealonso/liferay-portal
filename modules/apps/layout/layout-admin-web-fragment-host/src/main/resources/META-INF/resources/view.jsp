...
<%
System.out.println(">SessionMessages.contains(request, \"parentLayoutDeletionException\"): " + SessionMessages.contains(request, "parentLayoutDeletionException"));
%>

<p>SessionMessages.contains(request, "parentLayoutDeletionException"): <%= SessionMessages.contains(request, "parentLayoutDeletionException") %></p>
