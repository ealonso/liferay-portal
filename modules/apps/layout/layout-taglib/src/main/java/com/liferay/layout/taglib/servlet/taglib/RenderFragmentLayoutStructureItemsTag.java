...
import com.liferay.layout.taglib.internal.display.context.RenderFragmentLayoutStructureItemsDisplayContext;
 ...
 */
public class RenderFragmentLayoutStructureItemsTag extends IncludeTag {

	@Override
	public int doStartTag() throws JspException {
		request.setAttribute(
			RenderFragmentLayoutStructureItemsDisplayContext.class.getName(),
			new RenderFragmentLayoutStructureItemsDisplayContext(
				getFieldValues(),
	...
	private static final String _PAGE =
		"/render_fragment_layout_structure_items/page.jsp";
