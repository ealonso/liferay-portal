 ...
 * @author Rubén Pulido
 */
public class RenderFragmentLayoutStructureItemsDisplayContext {

	public RenderFragmentLayoutStructureItemsDisplayContext(
		...
		_showPreview = (boolean)_httpServletRequest.getAttribute(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RenderFragmentLayoutStructureItemsDisplayContext.class);
