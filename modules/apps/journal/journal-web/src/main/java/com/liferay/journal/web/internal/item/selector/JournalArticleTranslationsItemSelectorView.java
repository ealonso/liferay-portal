...
public class JournalArticleTranslationsItemSelectorView
	implements ItemSelectorView<JournalArticleTranslationsItemSelectorCriterion> {

	@Override
	public Class<JournalArticleTranslationsItemSelectorCriterion> getItemSelectorCriterionClass() {
	...
	public void renderHTML(
		...
		JournalArticleTranslationsItemSelectorCriterion journalArticleTranslationsItemSelectorCriterion,
