...
public class ObjectEntryServiceHttp {
	...
	public static boolean hasModelResourcePermission(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ObjectEntryServiceUtil.class, "hasModelResourcePermission",
				_hasModelResourcePermissionParameterTypes8);
	...
	public static boolean hasPortletResourcePermission(
			HttpPrincipal httpPrincipal, String actionId, long groupId,
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_hasPortletResourcePermissionParameterTypes9);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, actionId, groupId, objectDefinitionId);
	...
	public static com.liferay.object.model.ObjectEntry updateObjectEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateObjectEntryParameterTypes10);
	...
	private static final Class<?>[]
		_hasPortletResourcePermissionParameterTypes9 = new Class[] {
			String.class, long.class, long.class
		};
	private static final Class<?>[] _updateObjectEntryParameterTypes10 =
		new Class[] {
