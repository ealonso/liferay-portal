...
public class LayoutSetUtil {
	...
	*/
	public static List<LayoutSet> filterFindByGroupId(long groupId) {
	...
	*/
	public static List<LayoutSet> filterFindByGroupId(long groupId, int start,
		int end) {
	...
	* @throws NoSuchLayoutSetException if a layout set with the primary key could not be found
	*/
	public static LayoutSet[] filterFindByGroupId_PrevAndNext(
		long layoutSetId, long groupId,
		OrderByComparator<LayoutSet> orderByComparator)
		throws com.liferay.portal.NoSuchLayoutSetException {
		return getPersistence()
				   .filterFindByGroupId_PrevAndNext(layoutSetId, groupId,
			orderByComparator);
	}
