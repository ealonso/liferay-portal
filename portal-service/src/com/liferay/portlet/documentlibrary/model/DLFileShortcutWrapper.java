...
public class DLFileShortcutWrapper implements DLFileShortcut,
	...
	*/
	...
	/**
	* Returns the trash entry created when this document library file shortcut was moved to trash. The trash entry may belong to one of the ancestors of this document library file shortcut.
	*
	* @return the trash entry created when this document library file shortcut was moved to trash
	*/
	@Override
	...
	*/
	...
	/**
	* Returns <code>true</code> if this document library file shortcut is in trash.
	*
	* @return <code>true</code> if this document library file shortcut is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if the parent of this document library file shortcut is in trash.
	*
	* @return <code>true</code> if the parent of this document library file shortcut is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if this document library file shortcut was directly moved to the trash.
	*
	* @return <code>true</code> if this document library file shortcut was directly moved to the trash; <code>false</code> otherwise
	*/
	@Override
