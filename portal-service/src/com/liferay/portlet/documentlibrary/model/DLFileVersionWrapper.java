...
public class DLFileVersionWrapper implements DLFileVersion,
	...
	*/
	...
	/**
	* Returns the trash entry created when this document library file version was moved to trash. The trash entry may belong to one of the ancestors of this document library file version.
	*
	* @return the trash entry created when this document library file version was moved to trash
	*/
	@Override
	...
	*/
	...
	/**
	* Returns <code>true</code> if this document library file version is in trash.
	*
	* @return <code>true</code> if this document library file version is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if the parent of this document library file version is in trash.
	*
	* @return <code>true</code> if the parent of this document library file version is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if this document library file version was directly moved to the trash.
	*
	* @return <code>true</code> if this document library file version was directly moved to the trash; <code>false</code> otherwise
	*/
	@Override
