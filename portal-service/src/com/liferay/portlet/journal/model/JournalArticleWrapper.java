...
public class JournalArticleWrapper implements JournalArticle,
	...
	*/
	...
	/**
	* Returns the trash entry created when this journal article was moved to trash. The trash entry may belong to one of the ancestors of this journal article.
	*
	* @return the trash entry created when this journal article was moved to trash
	*/
	@Override
	...
	*/
	...
	/**
	* Returns <code>true</code> if this journal article is in trash.
	*
	* @return <code>true</code> if this journal article is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if the parent of this journal article is in trash.
	*
	* @return <code>true</code> if the parent of this journal article is in trash; <code>false</code> otherwise
	*/
	@Override
	...
	/**
	* Returns <code>true</code> if this journal article was directly moved to the trash.
	*
	* @return <code>true</code> if this journal article was directly moved to the trash; <code>false</code> otherwise
	*/
	@Override
