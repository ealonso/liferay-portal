...
package com.liferay.portal.route.service.persistence.test;
...
import com.liferay.portal.kernel.route.service.persistence.GroupFriendlyURLUtil;
...
public class GroupFriendlyURLPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newGroupFriendlyURL.setMvccVersion(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingGroupFriendlyURL.getMvccVersion(),
			newGroupFriendlyURL.getMvccVersion());
	...
	protected OrderByComparator<GroupFriendlyURL> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("GroupFriendlyURL",
			"mvccVersion", true, "uuid", true, "groupFriendlyURLId", true,
			"groupId", true, "companyId", true, "userId", true, "userName",
			true, "createDate", true, "modifiedDate", true, "friendlyURL",
	...
	protected GroupFriendlyURL addGroupFriendlyURL() throws Exception {
		...
		groupFriendlyURL.setMvccVersion(RandomTestUtil.nextLong());
