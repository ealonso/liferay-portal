...
public class LayoutSetPersistenceImpl extends BasePersistenceImpl<LayoutSet>
	...
	/**
	 * Returns all the layout sets that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching layout sets that the user has permission to view
	 */
	@Override
	public List<LayoutSet> filterFindByGroupId(long groupId) {
		return filterFindByGroupId(groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the layout sets that the user has permission to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link LayoutSetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param start the lower bound of the range of layout sets
	 * @param end the upper bound of the range of layout sets (not inclusive)
	 * @return the range of matching layout sets that the user has permission to view
	 */
	@Override
	public List<LayoutSet> filterFindByGroupId(long groupId, int start, int end) {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layout sets that the user has permissions to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link LayoutSetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param end the upper bound of the range of layout sets (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching layout sets that the user has permission to view
	 */
	@Override
	public List<LayoutSet> filterFindByGroupId(long groupId, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_LAYOUTSET_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_LAYOUTSET_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_LAYOUTSET_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(LayoutSetModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, LayoutSetImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, LayoutSetImpl.class);
			}
			...
			return (List<LayoutSet>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	/**
	 * Returns the layout sets before and after the current layout set in the ordered set of layout sets that the user has permission to view where groupId = &#63;.
	 *
	 * @param layoutSetId the primary key of the current layout set
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public LayoutSet[] filterFindByGroupId_PrevAndNext(long layoutSetId,
		long groupId, OrderByComparator<LayoutSet> orderByComparator)
		throws NoSuchLayoutSetException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(layoutSetId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, layoutSet,
					groupId, orderByComparator, true);

			array[1] = layoutSet;

			array[2] = filterGetByGroupId_PrevAndNext(session, layoutSet,
	...
	protected LayoutSet filterGetByGroupId_PrevAndNext(Session session,
		LayoutSet layoutSet, long groupId,
		OrderByComparator<LayoutSet> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns the number of layout sets that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching layout sets that the user has permission to view
	 */
	@Override
	public int filterCountByGroupId(long groupId) {
		...
		query.append(_FILTER_SQL_COUNT_LAYOUTSET_WHERE);
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "layoutSet.layoutSetId";
	private static final String _FILTER_SQL_SELECT_LAYOUTSET_WHERE = "SELECT DISTINCT {layoutSet.*} FROM LayoutSet layoutSet WHERE ";
	private static final String _FILTER_SQL_SELECT_LAYOUTSET_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {LayoutSet.*} FROM (SELECT DISTINCT layoutSet.layoutSetId FROM LayoutSet layoutSet WHERE ";
	private static final String _FILTER_SQL_SELECT_LAYOUTSET_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN LayoutSet ON TEMP_TABLE.layoutSetId = LayoutSet.layoutSetId";
	private static final String _FILTER_SQL_COUNT_LAYOUTSET_WHERE = "SELECT COUNT(DISTINCT layoutSet.layoutSetId) AS COUNT_VALUE FROM LayoutSet layoutSet WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "layoutSet";
	private static final String _FILTER_ENTITY_TABLE = "LayoutSet";
