...
public class LayoutPersistenceImpl
	...
	/**
	 * Returns the layout where groupId = &#63; and layoutId = &#63; or throws a <code>NoSuchLayoutException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public Layout findByG_L(long groupId, long layoutId)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_L(groupId, layoutId);
	...
	/**
	 * Returns the layout where groupId = &#63; and layoutId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param layoutId the layout ID
	 * @return the matching layout, or <code>null</code> if a matching layout could not be found
	 */
	@Override
	public Layout fetchByG_L(long groupId, long layoutId) {
		return fetchByG_L(groupId, layoutId, true);
	}

	/**
	 * Returns the layout where groupId = &#63; and layoutId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param layoutId the layout ID
	 * @param useFinderCache whether to use the finder cache
	...
	public Layout fetchByG_L(
		...
		if (useFinderCache && productionMode) {
			result = FinderCacheUtil.getResult(
				_finderPathFetchByG_L, finderArgs);
		}
	...
	/**
	 * Removes the layout where groupId = &#63; and layoutId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param layoutId the layout ID
	 * @return the layout that was removed
	 */
	@Override
	public Layout removeByG_L(long groupId, long layoutId)
		throws NoSuchLayoutException {

		Layout layout = findByG_L(groupId, layoutId);

		return remove(layout);
	}

	/**
	 * Returns the number of layouts where groupId = &#63; and layoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param layoutId the layout ID
	 * @return the number of matching layouts
	...
	/**
	 * Returns all the layouts where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Layout> findByG_P(long groupId, long parentLayoutId) {
		return findByG_P(
			groupId, parentLayoutId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the layouts where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P(
		long groupId, long parentLayoutId, int start, int end) {

		return findByG_P(groupId, parentLayoutId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P(
		...
		return findByG_P(
			groupId, parentLayoutId, start, end, orderByComparator, true);
	}
	...
	public List<Layout> findByG_P(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				...
				finderArgs = new Object[] {groupId, parentLayoutId};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByG_P;
			finderArgs = new Object[] {
				groupId, parentLayoutId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_PARENTLAYOUTID_2);
	...
	/**
	 * Returns the first layout in the ordered set where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Layout findByG_P_First(
		...
		Layout layout = fetchByG_P_First(
			groupId, parentLayoutId, orderByComparator);
	...
	public Layout fetchByG_P_First(
		...
		List<Layout> list = findByG_P(
			groupId, parentLayoutId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last layout in the ordered set where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Layout fetchByG_P_Last(
		...
		int count = countByG_P(groupId, parentLayoutId);
		...
		List<Layout> list = findByG_P(
			groupId, parentLayoutId, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	...
	public Layout[] findByG_P_PrevAndNext(
			long plid, long groupId, long parentLayoutId,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {
		...
		try {
			...
			array[0] = getByG_P_PrevAndNext(
				session, layout, groupId, parentLayoutId, orderByComparator,
				true);
	...
	protected Layout getByG_P_PrevAndNext(
		Session session, Layout layout, long groupId, long parentLayoutId,
		OrderByComparator<Layout> orderByComparator, boolean previous) {
	...
	/**
	 * Returns all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @return the matching layouts that the user has permission to view
	 */
	@Override
	public List<Layout> filterFindByG_P(long groupId, long parentLayoutId) {
	...
	/**
	 * Returns a range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P(
		...
		return filterFindByG_P(groupId, parentLayoutId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts that the user has permissions to view where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P(
		...
		sb.append(_FINDER_COLUMN_G_P_PARENTLAYOUTID_2_SQL);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	...
	public Layout[] filterFindByG_P_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P_PrevAndNext(
				plid, groupId, parentLayoutId, orderByComparator);
		}
	...
	/**
	 * Returns all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Layout> filterFindByG_P(long groupId, long[] parentLayoutIds) {
		return filterFindByG_P(
			groupId, parentLayoutIds, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Layout> filterFindByG_P(
		long groupId, long[] parentLayoutIds, int start, int end) {

		return filterFindByG_P(groupId, parentLayoutIds, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P(
				groupId, parentLayoutIds, start, end, orderByComparator);
		}
		...
		if (parentLayoutIds.length > 0) {
			...
			sb.append(_FINDER_COLUMN_G_P_PARENTLAYOUTID_7_SQL);
	...
	/**
	 * Returns all the layouts where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Layout> findByG_P(long groupId, long[] parentLayoutIds) {
		return findByG_P(
			groupId, parentLayoutIds, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	/**
	 * Returns a range of all the layouts where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P(
		...
		return findByG_P(groupId, parentLayoutIds, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P(
		...
		return findByG_P(
			groupId, parentLayoutIds, start, end, orderByComparator, true);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = &#63;, optionally using the finder cache.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P(
		...
		if (parentLayoutIds.length == 1) {
			return findByG_P(
				groupId, parentLayoutIds[0], start, end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderArgs = new Object[] {
					groupId, StringUtil.merge(parentLayoutIds)
				};
			}
		}
		else if (useFinderCache && productionMode) {
			finderArgs = new Object[] {
				groupId, StringUtil.merge(parentLayoutIds), start, end,
				orderByComparator
			};
		}
			...
			try {
				if ((start == QueryUtil.ALL_POS) &&
					...
					for (long[] parentLayoutIdsPage : parentLayoutIdsPages) {
						list.addAll(
							_findByG_P(
								groupId, parentLayoutIdsPage, start, end,
								orderByComparator));
					}
					...
					list = _findByG_P(
						groupId, parentLayoutIds, start, end,
						orderByComparator);
				}
	...
	private List<Layout> _findByG_P(
		long groupId, long[] parentLayoutIds, int start, int end,
		OrderByComparator<Layout> orderByComparator) {
		...
		if (parentLayoutIds.length > 0) {
			...
			sb.append(_FINDER_COLUMN_G_P_PARENTLAYOUTID_7);
	...
	/**
	 * Removes all the layouts where groupId = &#63; and parentLayoutId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 */
	@Override
	public void removeByG_P(long groupId, long parentLayoutId) {
		for (Layout layout :
				findByG_P(
					groupId, parentLayoutId, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of layouts where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @return the number of matching layouts
	 */
	@Override
	public int countByG_P(long groupId, long parentLayoutId) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			Layout.class);
	...
	/**
	 * Returns the number of layouts where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutIds the parent layout IDs
	 * @return the number of matching layouts
	 */
	@Override
	public int countByG_P(long groupId, long[] parentLayoutIds) {
		if (parentLayoutIds == null) {
			parentLayoutIds = new long[0];
		}
		else if (parentLayoutIds.length > 1) {
		...
		if (count == null) {
			try {
				if ((databaseInMaxParameters > 0) &&
					...
					for (long[] parentLayoutIdsPage : parentLayoutIdsPages) {
						count += Long.valueOf(
							_countByG_P(groupId, parentLayoutIdsPage));
					}
				}
				else {
					count = Long.valueOf(_countByG_P(groupId, parentLayoutIds));
				}
	...
	private int _countByG_P(long groupId, long[] parentLayoutIds) {
		Long count = null;
	...
	/**
	 * Returns the number of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @return the number of matching layouts that the user has permission to view
	 */
	@Override
	public int filterCountByG_P(long groupId, long parentLayoutId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P(groupId, parentLayoutId);
		}
	...
	/**
	 * Returns the number of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutIds the parent layout IDs
	 * @return the number of matching layouts that the user has permission to view
	 */
	@Override
	public int filterCountByG_P(long groupId, long[] parentLayoutIds) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P(groupId, parentLayoutIds);
		}
	...
	private static final String _FINDER_COLUMN_G_P_PARENTLAYOUTID_2 =
		"layout.parentLayoutId = ? AND layout.system = [$FALSE$]";

	private static final String _FINDER_COLUMN_G_P_PARENTLAYOUTID_7 =
		"layout.parentLayoutId IN (";

	private static final String _FINDER_COLUMN_G_P_PARENTLAYOUTID_2_SQL =
		"layout.parentLayoutId = ? AND layout.system_ = [$FALSE$]";

	private static final String _FINDER_COLUMN_G_P_PARENTLAYOUTID_7_SQL =
		"layout.parentLayoutId IN (";
	...
	/**
	 * Returns the layout where groupId = &#63; and friendlyURL = &#63; or throws a <code>NoSuchLayoutException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public Layout findByG_F(long groupId, String friendlyURL)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_F(groupId, friendlyURL);
	...
	/**
	 * Returns the layout where groupId = &#63; and friendlyURL = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param friendlyURL the friendly url
	 * @return the matching layout, or <code>null</code> if a matching layout could not be found
	 */
	@Override
	public Layout fetchByG_F(long groupId, String friendlyURL) {
		return fetchByG_F(groupId, friendlyURL, true);
	}

	/**
	 * Returns the layout where groupId = &#63; and friendlyURL = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param friendlyURL the friendly url
	 * @param useFinderCache whether to use the finder cache
	...
	/**
	 * Removes the layout where groupId = &#63; and friendlyURL = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param friendlyURL the friendly url
	 * @return the layout that was removed
	 */
	@Override
	public Layout removeByG_F(long groupId, String friendlyURL)
		throws NoSuchLayoutException {

		Layout layout = findByG_F(groupId, friendlyURL);

		return remove(layout);
	}

	/**
	 * Returns the number of layouts where groupId = &#63; and friendlyURL = &#63;.
	 *
	 * @param groupId the group ID
	 * @param friendlyURL the friendly url
	 * @return the number of matching layouts
	...
	private FinderPath _finderPathFetchByG_SPLU;
	private FinderPath _finderPathCountByG_SPLU;

	/**
	 * Returns the layout where groupId = &#63; and sourcePrototypeLayoutUuid = &#63; or throws a <code>NoSuchLayoutException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param sourcePrototypeLayoutUuid the source prototype layout uuid
	 * @return the matching layout
	 ...
	 */
	@Override
	public Layout findByG_SPLU(long groupId, String sourcePrototypeLayoutUuid)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_SPLU(groupId, sourcePrototypeLayoutUuid);
	...
	/**
	 * Returns the layout where groupId = &#63; and sourcePrototypeLayoutUuid = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param sourcePrototypeLayoutUuid the source prototype layout uuid
	 * @return the matching layout, or <code>null</code> if a matching layout could not be found
	 */
	@Override
	public Layout fetchByG_SPLU(
		long groupId, String sourcePrototypeLayoutUuid) {

		return fetchByG_SPLU(groupId, sourcePrototypeLayoutUuid, true);
	}

	/**
	 * Returns the layout where groupId = &#63; and sourcePrototypeLayoutUuid = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param sourcePrototypeLayoutUuid the source prototype layout uuid
	 * @param useFinderCache whether to use the finder cache
	...
	public Layout fetchByG_SPLU(
		...
		if (useFinderCache && productionMode) {
			finderArgs = new Object[] {groupId, sourcePrototypeLayoutUuid};
		}
		...
		if (useFinderCache && productionMode) {
			result = FinderCacheUtil.getResult(
				_finderPathFetchByG_SPLU, finderArgs);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_G_SPLU_GROUPID_2);

			boolean bindSourcePrototypeLayoutUuid = false;

			if (sourcePrototypeLayoutUuid.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_SPLU_SOURCEPROTOTYPELAYOUTUUID_3);
			}
			else {
				bindSourcePrototypeLayoutUuid = true;

				sb.append(_FINDER_COLUMN_G_SPLU_SOURCEPROTOTYPELAYOUTUUID_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache && productionMode) {
						FinderCacheUtil.putResult(
							_finderPathFetchByG_SPLU, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"LayoutPersistenceImpl.fetchByG_SPLU(long, String, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	/**
	 * Removes the layout where groupId = &#63; and sourcePrototypeLayoutUuid = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param sourcePrototypeLayoutUuid the source prototype layout uuid
	 * @return the layout that was removed
	 */
	@Override
	public Layout removeByG_SPLU(long groupId, String sourcePrototypeLayoutUuid)
		throws NoSuchLayoutException {

		Layout layout = findByG_SPLU(groupId, sourcePrototypeLayoutUuid);

		return remove(layout);
	}

	/**
	 * Returns the number of layouts where groupId = &#63; and sourcePrototypeLayoutUuid = &#63;.
	 *
	 * @param groupId the group ID
	 * @param sourcePrototypeLayoutUuid the source prototype layout uuid
	 * @return the number of matching layouts
	 */
	@Override
	public int countByG_SPLU(long groupId, String sourcePrototypeLayoutUuid) {
		sourcePrototypeLayoutUuid = Objects.toString(
			sourcePrototypeLayoutUuid, "");
		...
		if (productionMode) {
			finderPath = _finderPathCountByG_SPLU;
	...
	private static final String _FINDER_COLUMN_G_SPLU_GROUPID_2 =
		"layout.groupId = ? AND ";

	private static final String
		_FINDER_COLUMN_G_SPLU_SOURCEPROTOTYPELAYOUTUUID_2 =
			"layout.sourcePrototypeLayoutUuid = ?";

	private static final String
		_FINDER_COLUMN_G_SPLU_SOURCEPROTOTYPELAYOUTUUID_3 =
			"(layout.sourcePrototypeLayoutUuid IS NULL OR layout.sourcePrototypeLayoutUuid = '')";

	private FinderPath _finderPathWithPaginationFindByG_P_H;
	private FinderPath _finderPathWithoutPaginationFindByG_P_H;
	private FinderPath _finderPathCountByG_P_H;
	private FinderPath _finderPathWithPaginationCountByG_P_H;

	/**
	 * Returns all the layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public List<Layout> findByG_P_H(
		long groupId, long parentLayoutId, boolean hidden) {

		return findByG_P_H(
			groupId, parentLayoutId, hidden, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Layout> findByG_P_H(
		long groupId, long parentLayoutId, boolean hidden, int start, int end) {

		return findByG_P_H(groupId, parentLayoutId, hidden, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P_H(
		...
		return findByG_P_H(
			groupId, parentLayoutId, hidden, start, end, orderByComparator,
			true);
	}
	...
	public List<Layout> findByG_P_H(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByG_P_H;
				finderArgs = new Object[] {groupId, parentLayoutId, hidden};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByG_P_H;
			finderArgs = new Object[] {
				groupId, parentLayoutId, hidden, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_H_GROUPID_2);

			sb.append(_FINDER_COLUMN_G_P_H_PARENTLAYOUTID_2);

			sb.append(_FINDER_COLUMN_G_P_H_HIDDEN_2);
	...
	/**
	 * Returns the first layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	 ...
	 */
	@Override
	public Layout findByG_P_H_First(
			long groupId, long parentLayoutId, boolean hidden,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_P_H_First(
			groupId, parentLayoutId, hidden, orderByComparator);
	 ...
	 */
	@Override
	public Layout fetchByG_P_H_First(
		long groupId, long parentLayoutId, boolean hidden,
		OrderByComparator<Layout> orderByComparator) {

		List<Layout> list = findByG_P_H(
			groupId, parentLayoutId, hidden, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	 ...
	 */
	@Override
	public Layout findByG_P_H_Last(
			long groupId, long parentLayoutId, boolean hidden,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_P_H_Last(
			groupId, parentLayoutId, hidden, orderByComparator);
	 ...
	 */
	@Override
	public Layout fetchByG_P_H_Last(
		long groupId, long parentLayoutId, boolean hidden,
		OrderByComparator<Layout> orderByComparator) {

		int count = countByG_P_H(groupId, parentLayoutId, hidden);
		...
		List<Layout> list = findByG_P_H(
			groupId, parentLayoutId, hidden, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public Layout[] findByG_P_H_PrevAndNext(
			long plid, long groupId, long parentLayoutId, boolean hidden,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {
		...
		try {
			...
			array[0] = getByG_P_H_PrevAndNext(
				session, layout, groupId, parentLayoutId, hidden,
				orderByComparator, true);

			array[1] = layout;

			array[2] = getByG_P_H_PrevAndNext(
				session, layout, groupId, parentLayoutId, hidden,
				orderByComparator, false);
	...
	protected Layout getByG_P_H_PrevAndNext(
		Session session, Layout layout, long groupId, long parentLayoutId,
	...
	/**
	 * Returns all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	 ...
	 */
	@Override
	public List<Layout> filterFindByG_P_H(
		long groupId, long parentLayoutId, boolean hidden) {

		return filterFindByG_P_H(
			groupId, parentLayoutId, hidden, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P_H(
		...
		return filterFindByG_P_H(
			groupId, parentLayoutId, hidden, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts that the user has permissions to view where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P_H(
		...
		sb.append(_FINDER_COLUMN_G_P_H_GROUPID_2_SQL);

		sb.append(_FINDER_COLUMN_G_P_H_PARENTLAYOUTID_2_SQL);

		sb.append(_FINDER_COLUMN_G_P_H_HIDDEN_2_SQL);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public Layout[] filterFindByG_P_H_PrevAndNext(
			long plid, long groupId, long parentLayoutId, boolean hidden,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P_H_PrevAndNext(
				plid, groupId, parentLayoutId, hidden, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_P_H_PrevAndNext(
				session, layout, groupId, parentLayoutId, hidden,
				orderByComparator, true);

			array[1] = layout;

			array[2] = filterGetByG_P_H_PrevAndNext(
				session, layout, groupId, parentLayoutId, hidden,
				orderByComparator, false);
	...
	protected Layout filterGetByG_P_H_PrevAndNext(
		Session session, Layout layout, long groupId, long parentLayoutId,
		boolean hidden, OrderByComparator<Layout> orderByComparator,
		boolean previous) {
	...
	/**
	 * Returns all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutIds the parent layout IDs
	 * @param hidden the hidden
	...
	@Override
	public List<Layout> filterFindByG_P_H(
		long groupId, long[] parentLayoutIds, boolean hidden) {

		return filterFindByG_P_H(
			groupId, parentLayoutIds, hidden, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Layout> filterFindByG_P_H(
		long groupId, long[] parentLayoutIds, boolean hidden, int start,
		int end) {

		return filterFindByG_P_H(
			groupId, parentLayoutIds, hidden, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P_H(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P_H(
				groupId, parentLayoutIds, hidden, start, end,
				orderByComparator);
		}
		...
		if (parentLayoutIds.length > 0) {
			...
			sb.append(_FINDER_COLUMN_G_P_H_PARENTLAYOUTID_7_SQL);
	...
	/**
	 * Returns all the layouts where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns a range of all the layouts where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P_H(
		...
		return findByG_P_H(groupId, parentLayoutIds, hidden, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P_H(
		...
		return findByG_P_H(
			groupId, parentLayoutIds, hidden, start, end, orderByComparator,
			true);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;, optionally using the finder cache.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P_H(
		...
		if (parentLayoutIds.length == 1) {
			return findByG_P_H(
				groupId, parentLayoutIds[0], hidden, start, end,
				orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderArgs = new Object[] {
					groupId, StringUtil.merge(parentLayoutIds), hidden
				};
			}
		}
		else if (useFinderCache && productionMode) {
			finderArgs = new Object[] {
				groupId, StringUtil.merge(parentLayoutIds), hidden, start, end,
				orderByComparator
			};
		}
		...
		if (useFinderCache && productionMode) {
			list = (List<Layout>)FinderCacheUtil.getResult(
				_finderPathWithPaginationFindByG_P_H, finderArgs);
			...
			try {
				if ((start == QueryUtil.ALL_POS) &&
					...
					for (long[] parentLayoutIdsPage : parentLayoutIdsPages) {
						list.addAll(
							_findByG_P_H(
								groupId, parentLayoutIdsPage, hidden, start,
				...
				if (useFinderCache && productionMode) {
					FinderCacheUtil.putResult(
						_finderPathWithPaginationFindByG_P_H, finderArgs, list);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
	...
	private List<Layout> _findByG_P_H(
		long groupId, long[] parentLayoutIds, boolean hidden, int start,
		int end, OrderByComparator<Layout> orderByComparator) {
		...
		if (parentLayoutIds.length > 0) {
			...
			sb.append(_FINDER_COLUMN_G_P_H_PARENTLAYOUTID_7);
	...
	/**
	 * Removes all the layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	...
	/**
	 * Returns the number of layouts where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	 ...
	 */
	@Override
	public int countByG_P_H(long groupId, long parentLayoutId, boolean hidden) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			Layout.class);
		...
		if (productionMode) {
			finderPath = _finderPathCountByG_P_H;
	...
	/**
	 * Returns the number of layouts where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutIds the parent layout IDs
	 * @param hidden the hidden
	...
	public int countByG_P_H(
		...
		if (productionMode) {
			...
			count = (Long)FinderCacheUtil.getResult(
				_finderPathWithPaginationCountByG_P_H, finderArgs);
		}
			...
			try {
				if ((databaseInMaxParameters > 0) &&
					...
					for (long[] parentLayoutIdsPage : parentLayoutIdsPages) {
						count += Long.valueOf(
							_countByG_P_H(
								groupId, parentLayoutIdsPage, hidden));
					}
				}
				else {
					count = Long.valueOf(
						_countByG_P_H(groupId, parentLayoutIds, hidden));
				}
	...
	/**
	 * Returns the number of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param hidden the hidden
	 ...
	 */
	@Override
	public int filterCountByG_P_H(
		long groupId, long parentLayoutId, boolean hidden) {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P_H(groupId, parentLayoutId, hidden);
		}
	...
	/**
	 * Returns the number of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = any &#63; and hidden = &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutIds the parent layout IDs
	 * @param hidden the hidden
	...
	public int filterCountByG_P_H(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P_H(groupId, parentLayoutIds, hidden);
		}
	...
	private static final String _FINDER_COLUMN_G_P_H_GROUPID_2 =
		"layout.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_H_GROUPID_2_SQL =
		"layout.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_H_PARENTLAYOUTID_2 =
		"layout.parentLayoutId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_H_PARENTLAYOUTID_7 =
		"layout.parentLayoutId IN (";

	private static final String _FINDER_COLUMN_G_P_H_PARENTLAYOUTID_2_SQL =
		"layout.parentLayoutId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_H_PARENTLAYOUTID_7_SQL =
		"layout.parentLayoutId IN (";

	private static final String _FINDER_COLUMN_G_P_H_HIDDEN_2 =
		"layout.hidden = ? AND layout.system = [$FALSE$]";

	private static final String _FINDER_COLUMN_G_P_H_HIDDEN_2_SQL =
	...
	/**
	 * Returns all the layouts where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public List<Layout> findByG_P_LtP(
		long groupId, long parentLayoutId, int priority) {

		return findByG_P_LtP(
			groupId, parentLayoutId, priority, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the layouts where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Layout> findByG_P_LtP(
		long groupId, long parentLayoutId, int priority, int start, int end) {

		return findByG_P_LtP(
			groupId, parentLayoutId, priority, start, end, null);
	}

	/**
	 * Returns an ordered range of all the layouts where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> findByG_P_LtP(
		...
		return findByG_P_LtP(
			groupId, parentLayoutId, priority, start, end, orderByComparator,
			true);
	}
	...
	public List<Layout> findByG_P_LtP(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_P_LTP_PARENTLAYOUTID_2);
	...
	/**
	 * Returns the first layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	 ...
	 */
	@Override
	public Layout findByG_P_LtP_First(
			long groupId, long parentLayoutId, int priority,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_P_LtP_First(
			groupId, parentLayoutId, priority, orderByComparator);
	 ...
	 */
	@Override
	public Layout fetchByG_P_LtP_First(
		long groupId, long parentLayoutId, int priority,
		OrderByComparator<Layout> orderByComparator) {

		List<Layout> list = findByG_P_LtP(
			groupId, parentLayoutId, priority, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	 ...
	 */
	@Override
	public Layout findByG_P_LtP_Last(
			long groupId, long parentLayoutId, int priority,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {

		Layout layout = fetchByG_P_LtP_Last(
			groupId, parentLayoutId, priority, orderByComparator);
	 ...
	 */
	@Override
	public Layout fetchByG_P_LtP_Last(
		long groupId, long parentLayoutId, int priority,
		OrderByComparator<Layout> orderByComparator) {

		int count = countByG_P_LtP(groupId, parentLayoutId, priority);
		...
		List<Layout> list = findByG_P_LtP(
			groupId, parentLayoutId, priority, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public Layout[] findByG_P_LtP_PrevAndNext(
			long plid, long groupId, long parentLayoutId, int priority,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {
		...
		try {
			...
			array[0] = getByG_P_LtP_PrevAndNext(
				session, layout, groupId, parentLayoutId, priority,
				orderByComparator, true);
	...
	protected Layout getByG_P_LtP_PrevAndNext(
		Session session, Layout layout, long groupId, long parentLayoutId,
	...
	/**
	 * Returns all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	 ...
	 */
	@Override
	public List<Layout> filterFindByG_P_LtP(
		long groupId, long parentLayoutId, int priority) {
	...
	/**
	 * Returns a range of all the layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the layouts that the user has permissions to view where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>LayoutModelImpl</code>.
	 * </p>
	...
	public List<Layout> filterFindByG_P_LtP(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P_LtP(
				groupId, parentLayoutId, priority, start, end,
				orderByComparator);
		}
		...
		sb.append(_FINDER_COLUMN_G_P_LTP_PARENTLAYOUTID_2_SQL);
	...
	/**
	 * Returns the layouts before and after the current layout in the ordered set of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param plid the primary key of the current layout
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 ...
	 */
	@Override
	public Layout[] filterFindByG_P_LtP_PrevAndNext(
			long plid, long groupId, long parentLayoutId, int priority,
			OrderByComparator<Layout> orderByComparator)
		throws NoSuchLayoutException {
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_P_LtP_PrevAndNext(
				plid, groupId, parentLayoutId, priority, orderByComparator);
		}
	...
	protected Layout filterGetByG_P_LtP_PrevAndNext(
		Session session, Layout layout, long groupId, long parentLayoutId,
		int priority, OrderByComparator<Layout> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the layouts where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	...
	/**
	 * Returns the number of layouts where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	 ...
	 */
	@Override
	public int countByG_P_LtP(long groupId, long parentLayoutId, int priority) {
		boolean productionMode = CTPersistenceHelperUtil.isProductionMode(
			Layout.class);
		...
		if (productionMode) {
			...
			finderArgs = new Object[] {groupId, parentLayoutId, priority};
	...
	/**
	 * Returns the number of layouts that the user has permission to view where groupId = &#63; and parentLayoutId = &#63; and priority &le; &#63;.
	 *
	 * @param groupId the group ID
	 * @param parentLayoutId the parent layout ID
	 * @param priority the priority
	 ...
	 */
	@Override
	public int filterCountByG_P_LtP(
		long groupId, long parentLayoutId, int priority) {

		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_P_LtP(groupId, parentLayoutId, priority);
		}
	...
	private static final String _FINDER_COLUMN_G_P_LTP_PARENTLAYOUTID_2 =
		"layout.parentLayoutId = ? AND ";

	private static final String _FINDER_COLUMN_G_P_LTP_PARENTLAYOUTID_2_SQL =
		"layout.parentLayoutId = ? AND ";
	...
	public void cacheResult(Layout layout) {
		...
		FinderCacheUtil.putResult(
			...
			new Object[] {layout.getGroupId(), layout.getLayoutId()}, layout);

		FinderCacheUtil.putResult(
			_finderPathFetchByG_F,
			new Object[] {layout.getGroupId(), layout.getFriendlyURL()},
			layout);

		FinderCacheUtil.putResult(
			_finderPathFetchByG_SPLU,
			new Object[] {
				layout.getGroupId(), layout.getSourcePrototypeLayoutUuid()
			},
			layout);
	}
	...
	protected void cacheUniqueFindersCache(LayoutModelImpl layoutModelImpl) {
		...
		args = new Object[] {
			layoutModelImpl.getGroupId(), layoutModelImpl.getLayoutId()
		};

		FinderCacheUtil.putResult(_finderPathCountByG_L, args, Long.valueOf(1));
		FinderCacheUtil.putResult(_finderPathFetchByG_L, args, layoutModelImpl);

		args = new Object[] {
			layoutModelImpl.getGroupId(), layoutModelImpl.getFriendlyURL()
		};

		FinderCacheUtil.putResult(_finderPathCountByG_F, args, Long.valueOf(1));
		FinderCacheUtil.putResult(_finderPathFetchByG_F, args, layoutModelImpl);
		...
		FinderCacheUtil.putResult(
			_finderPathCountByG_SPLU, args, Long.valueOf(1));
		FinderCacheUtil.putResult(
			_finderPathFetchByG_SPLU, args, layoutModelImpl);
	}
	...
	static {
		...
		_uniqueIndexColumnNames.add(new String[] {"groupId", "layoutId"});
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByG_P = new FinderPath(
			...
			new String[] {"groupId", "parentLayoutId"}, true);
		...
		_finderPathCountByG_P = new FinderPath(
			...
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"groupId", "parentLayoutId"}, false);
		...
		_finderPathFetchByG_SPLU = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByG_SPLU",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "sourcePrototypeLayoutUuid"}, true);

		_finderPathCountByG_SPLU = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_SPLU",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "sourcePrototypeLayoutUuid"}, false);

		_finderPathWithPaginationFindByG_P_H = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_P_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"groupId", "parentLayoutId", "hidden_"}, true);

		_finderPathWithoutPaginationFindByG_P_H = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_P_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPathCountByG_P_H = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_P_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
			new String[] {"groupId", "parentLayoutId", "hidden_"}, false);

		_finderPathWithPaginationCountByG_P_H = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_P_H",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			},
		...
		_finderPathWithPaginationFindByG_P_LtP = new FinderPath(
			...
			new String[] {"groupId", "parentLayoutId", "priority"}, true);
		...
		_finderPathWithPaginationCountByG_P_LtP = new FinderPath(
			...
			new String[] {"groupId", "parentLayoutId", "priority"}, false);
	}
