...
public interface ${entity.name}Model extends
	...
	<#if entity.isTrashedModel()>
		/**
		 * Returns the trash entry created when this ${entity.humanName} was moved to trash. The trash entry may belong to one of the ancestors of this ${entity.humanName}.
		 *
		 * @return the trash entry created when this ${entity.humanName} was moved to trash
		 */
		...
		/**
		 * Returns <code>true</code> if this ${entity.humanName} is in trash.
		 *
		 * @return <code>true</code> if this ${entity.humanName} is in trash; <code>false</code> otherwise
		 */
		public boolean isInTrash();

		/**
		 * Returns <code>true</code> if the parent of this ${entity.humanName} is in trash.
		 *
		 * @return <code>true</code> if the parent of this ${entity.humanName} is in trash; <code>false</code> otherwise
		 */
		public boolean isInTrashContainer() throws PortalException, SystemException;

		/**
		 * Returns <code>true</code> if this ${entity.humanName} was directly moved to the trash.
		 *
		 * @return <code>true</code> if this ${entity.humanName} was directly moved to the trash; <code>false</code> otherwise
		 */
