...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_T = new FinderPath(BookmarksEntryModelImpl.ENTITY_CACHE_ENABLED,
			BookmarksEntryModelImpl.FINDER_CACHE_ENABLED,
			BookmarksEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_T",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_T = new FinderPath(BookmarksEntryModelImpl.ENTITY_CACHE_ENABLED,
			BookmarksEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_T",
			new String[] { Long.class.getName(), String.class.getName() });

	/**
	 * Returns all the bookmarks entries where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<BookmarksEntry> findByC_T(long companyId, String treePath) {
		return findByC_T(companyId, treePath, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the bookmarks entries where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.bookmarks.model.impl.BookmarksEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the bookmarks entries where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.bookmarks.model.impl.BookmarksEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
			...
			for (BookmarksEntry bookmarksEntry : list) {
				if ((companyId != bookmarksEntry.getCompanyId()) ||
						!StringUtil.wildcardMatches(
							bookmarksEntry.getTreePath(), treePath,
	...
	/**
	 * Returns the first bookmarks entry in the ordered set where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * @param companyId the company ID
	 * @param treePath the tree path
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public BookmarksEntry findByC_T_First(long companyId, String treePath,
		OrderByComparator<BookmarksEntry> orderByComparator)
		throws NoSuchEntryException {
		BookmarksEntry bookmarksEntry = fetchByC_T_First(companyId, treePath,
				orderByComparator);
	 ...
	 */
	@Override
	public BookmarksEntry fetchByC_T_First(long companyId, String treePath,
		OrderByComparator<BookmarksEntry> orderByComparator) {
		List<BookmarksEntry> list = findByC_T(companyId, treePath, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last bookmarks entry in the ordered set where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * @param companyId the company ID
	 * @param treePath the tree path
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public BookmarksEntry findByC_T_Last(long companyId, String treePath,
		OrderByComparator<BookmarksEntry> orderByComparator)
		throws NoSuchEntryException {
		BookmarksEntry bookmarksEntry = fetchByC_T_Last(companyId, treePath,
				orderByComparator);
	 ...
	 */
	@Override
	public BookmarksEntry fetchByC_T_Last(long companyId, String treePath,
		OrderByComparator<BookmarksEntry> orderByComparator) {
		...
		List<BookmarksEntry> list = findByC_T(companyId, treePath, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the bookmarks entries before and after the current bookmarks entry in the ordered set where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * @param entryId the primary key of the current bookmarks entry
	 * @param companyId the company ID
	 * @param treePath the tree path
	 ...
	 */
	@Override
	public BookmarksEntry[] findByC_T_PrevAndNext(long entryId, long companyId,
		String treePath, OrderByComparator<BookmarksEntry> orderByComparator)
		throws NoSuchEntryException {
		BookmarksEntry bookmarksEntry = findByPrimaryKey(entryId);
		...
		try {
			...
			array[0] = getByC_T_PrevAndNext(session, bookmarksEntry, companyId,
					treePath, orderByComparator, true);

			array[1] = bookmarksEntry;

			array[2] = getByC_T_PrevAndNext(session, bookmarksEntry, companyId,
	...
	protected BookmarksEntry getByC_T_PrevAndNext(Session session,
		BookmarksEntry bookmarksEntry, long companyId, String treePath,
		OrderByComparator<BookmarksEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the bookmarks entries where companyId = &#63; and treePath LIKE &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param treePath the tree path
	 */
	...
	public void removeByC_T(long companyId, String treePath) {
		for (BookmarksEntry bookmarksEntry : findByC_T(companyId, treePath,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(bookmarksEntry);
		}
	}
	...
	/**
	 * Returns the number of bookmarks entries where companyId = &#63; and treePath LIKE &#63;.
	 *
	 * @param companyId the company ID
	 * @param treePath the tree path
	 * @return the number of matching bookmarks entries
	...
	private static final String _FINDER_COLUMN_C_T_COMPANYID_2 = "bookmarksEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_T_TREEPATH_1 = "bookmarksEntry.treePath LIKE NULL";
	private static final String _FINDER_COLUMN_C_T_TREEPATH_2 = "bookmarksEntry.treePath LIKE ?";
	private static final String _FINDER_COLUMN_C_T_TREEPATH_3 = "(bookmarksEntry.treePath IS NULL OR bookmarksEntry.treePath LIKE '')";
