...
portletURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_assignments");
...
assignMembersURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_assignments");
