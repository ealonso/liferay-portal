...
permissionsAllURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_permissions");
...
for (int i = 0; i < results.size(); i++) {
	...
	editPermissionsResourceURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_permissions");
	...
	editPermissionsURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_permissions");
