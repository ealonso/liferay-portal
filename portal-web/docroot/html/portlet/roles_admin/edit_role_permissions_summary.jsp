...
permissionsAllURL.setParameter("mvcPath", "/roles_admin/edit_role_permissions");
...
for (int i = 0; i < results.size(); i++) {
	...
	editPermissionsResourceURL.setParameter("mvcPath", "/roles_admin/edit_role_permissions");
	...
	editPermissionsURL.setParameter("mvcPath", "/roles_admin/edit_role_permissions");
