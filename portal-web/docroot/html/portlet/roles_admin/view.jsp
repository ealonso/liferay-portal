...
portletURL.setParameter("mvcPath", "/html/portlet/roles_admin/view");
	...
	>
			...
			<aui:nav cssClass="navbar-nav">
				<c:if test="<%= PortalPermissionUtil.contains(permissionChecker, ActionKeys.ADD_ROLE) %>">
					<portlet:renderURL var="viewRolesURL">
						<portlet:param name="mvcPath" value="/html/portlet/roles_admin/view" />
					</portlet:renderURL>
		...
		>
			...
			if (RolePermissionUtil.contains(permissionChecker, role.getRoleId(), ActionKeys.UPDATE)) {
				...
				rowURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role");
