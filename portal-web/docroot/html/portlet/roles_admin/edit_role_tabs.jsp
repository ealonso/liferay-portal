...
editRoleURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role");
...
definePermissionsURL.setParameter("mvcPath", "/html/portlet/roles_admin/edit_role_permissions");
